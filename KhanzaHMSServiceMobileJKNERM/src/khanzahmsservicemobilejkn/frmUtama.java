                    ...
                    try {
                        ...
                        try {
                            ...
                            while(rs.next()){
                                ...
                                /*    koneksibpjs.prepareStatement(
                                        "insert into log_add_antrian values('0','"+rs.getString("nobooking")+"',"addantrian","","",'"+rs.getString("nm_pasien")+"','"+rs.getString("no_rawat")+"','"+rs.getString("nm_poli")+"')").executeUpdate(); */
                                //    Sequel.menyimpanbpjs("log_taskid", "?,?,?",3, new String[]{rs.getString("nobooking"),nameNode.path("code").asText(),nameNode.path("message").asText()});
                                        ...
                                        if(!datajam.equals("")){
                                            if(Sequel.menyimpantf2("referensi_mobilejkn_bpjs_taskid","?,?,?","task id",3,new String[]{rs.getString("no_rawat"),"99",datajam})==true){
                                                ...
                                                try {     
                                                    ...
                                                    koneksibpjs.prepareStatement(
                                                    "insert into log_add_antrian values('0','"+rs.getString("tgl_registrasi")+"','"+rs.getString("nobooking")+"','batal','admin','"+utc+"','"+rs.getString("nm_pasien")+"','"+rs.getString("no_rawat")+"',"+
                                                    "'"+rs.getString("nm_poli")+"','"+root+"','"+nameNode.path("code").asText()+"','"+requestJson+"','"+headers+"','"+URL+"')").executeUpdate();
                                            //        Sequel.menyimpanbpjs("log_taskid", "?,?,?",3, new String[]{rs.getString("nobooking"),nameNode.path("code").asText(),nameNode.path("message").asText()});
                                                }catch (Exception ex) {
                                                    System.out.println("Notifikasi Bridging : "+ex);
                                        ...
                                        if((!kodedokter.equals(""))&&(!kodepoli.equals(""))){
                                            ...
                                            try {     
                                                ...
                                                if(!rs.getString("kd_pj").equals(kodebpjs)){
                                                    ...
                                                    TeksArea.append("respon WS BPJS : "+nameNode.path("code").asText()+" "+nameNode.path("message").asText()+"\n");
                                                    koneksibpjs.prepareStatement(
                                                "insert into log_add_antrian values('0','"+rs.getString("tgl_registrasi")+"','"+rs.getString("no_rawat")+"','addantrian','admin','"+utc+"','"+rs.getString("nm_pasien")+"','"+rs.getString("no_rawat")+"',"+
                                                 "'"+rs.getString("nm_poli")+"','"+root+"','"+nameNode.path("code").asText()+"','"+requestJson+"','"+headers+"','"+URL+"')").executeUpdate();
