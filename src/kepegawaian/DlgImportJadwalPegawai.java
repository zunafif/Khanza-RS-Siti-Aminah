 ...
 * @author dosen
 */
public final class DlgImportJadwalPegawai extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgImportJadwalPegawai(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgImportJadwalPegawai dialog = new DlgImportJadwalPegawai(new javax.swing.JFrame(), true);
