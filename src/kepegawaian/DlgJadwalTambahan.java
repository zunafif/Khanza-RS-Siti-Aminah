...
public class DlgJadwalTambahan extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        BtnPrint.setBounds(590, 10, 100, 30);
        ...
        BtnKeluar.setBounds(700, 10, 100, 30);
        ...
        LCount.setBounds(290, 15, 60, 23);

        jLabel7.setText("Record :");
        jLabel7.setName("jLabel7"); // NOI18N
        jLabel7.setPreferredSize(new java.awt.Dimension(65, 23));
        panelGlass8.add(jLabel7);
        jLabel7.setBounds(210, 15, 70, 23);
        ...
        BtnExport.setBounds(370, 10, 100, 30);

        BtnImport.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/upload1-24.png"))); // NOI18N
        ...
        panelGlass8.add(BtnImport);
        BtnImport.setBounds(480, 10, 100, 30);
  ...
  private void BtnImportActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnImportActionPerformed
    this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
    DlgImportJadwalTambahanPegawai form = new DlgImportJadwalTambahanPegawai(null,false);
    form.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
    form.setLocationRelativeTo(internalFrame1);
    form.setVisible(true);
    form.setBulanTahun(BlnCari.getSelectedItem().toString(), ThnCari.getSelectedItem().toString());
    this.setCursor(Cursor.getDefaultCursor());
  ...
  private void exportJadwal(DefaultTableModel tableModel, String filePath){
    WritableWorkbook workbook = null;
    try {
      workbook = Workbook.createWorkbook(new File(filePath));
      WritableSheet sheet = workbook.createSheet("Jadwal Presensi", 0);

      int colIndex = 0;
      for (int i = 0; i < tableModel.getColumnCount(); i++) {
        if (i == 3 || i == 4) {
          continue; // Skip columns 4 and 5 (index 3 and 4)
        }
