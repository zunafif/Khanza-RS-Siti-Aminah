...
public class DlgJadwalPegawai extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        BtnPrint.setBounds(650, 10, 100, 30);
        ...
        BtnKeluar.setBounds(760, 10, 100, 30);
        ...
        LCount.setBounds(280, 16, 50, 23);

        jLabel7.setText("Record :");
        jLabel7.setName("jLabel7"); // NOI18N
        jLabel7.setPreferredSize(new java.awt.Dimension(65, 23));
        panelGlass8.add(jLabel7);
        jLabel7.setBounds(210, 16, 60, 23);
        ...
        BtnImport.setMnemonic('U');
        BtnImport.setText("Import");
        BtnImport.setToolTipText("Alt+U");
        ...
        BtnImport.setBounds(540, 10, 100, 30);
        ...
        BtnExport.setBounds(430, 10, 100, 30);
  ...
  private void BtnImportActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnImportActionPerformed
    this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
    DlgImportJadwalPegawai form = new DlgImportJadwalPegawai(null,false);
  ...
  public void exportJadwal(DefaultTableModel tableModel, String filePath) {
