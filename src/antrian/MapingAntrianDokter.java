 ...
 * @author dosen
 */
public final class MapingAntrianDokter extends javax.swing.JDialog {
    ...
    private DlgCariDokter poli2=new DlgCariDokter(null,false);
     ...
     * @param parent
     * @param modal */
    public MapingAntrianDokter(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            "Kode Dokter","Nama Dokter","Kode Dokter Antrian","Nama Dokter Antrian"}){
        ...
        poli2.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if(poli.getTable().getSelectedRow()!= -1){                    
                    KdPoliPCare.setText(poli2.getTable().getValueAt(poli2.getTable().getSelectedRow(),0).toString());
                    NmPoliPCare.setText(poli2.getTable().getValueAt(poli2.getTable().getSelectedRow(),1).toString());
                }
                kdpoli.requestFocus();
            }
            @Override
        ...
        poli2.getTable().addKeyListener(new KeyListener() {
            @Override
            public void keyTyped(KeyEvent e) {}
            @Override
            public void keyPressed(KeyEvent e) {
    ...
    private void initComponents() {
        ...
        jLabel19.setText("Antrian Dokter :");
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(kdpoli.getText().trim().equals("")||TPoli.getText().trim().equals("")){
            Valid.textKosong(kdpoli,"Dokter");
        }else if(KdPoliPCare.getText().trim().equals("")||NmPoliPCare.getText().trim().equals("")){
            Valid.textKosong(KdPoliPCare,"Dokter Antrian");
        }else{
            if(Sequel.menyimpantf("maping_dokter_antrian","?,?,?","Mapping Dokter",3,new String[]{
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        Valid.hapusTable(tabMode,kdpoli,"maping_dokter_antrian","kd_dokter");
        tampil();
        emptTeks();
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(kdpoli.getText().trim().equals("")||TPoli.getText().trim().equals("")){
            ...
            if(tbJnsPerawatan.getSelectedRow()>-1){
                if(Sequel.mengedittf("maping_dokter_antrian","kd_dokter=?","kd_dokter=?,kd_dokter_antrian=?,nm_dokter_antrian=?",4,new String[]{
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            MapingAntrianDokter dialog = new MapingAntrianDokter(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try{
           ps=koneksi.prepareStatement(
                   "select maping_dokter_antrian.kd_dokter,dokter.nm_dokter,maping_dokter_antrian.kd_dokter_antrian,maping_dokter_antrian.nm_dokter_antrian "+
                   "from maping_dokter_antrian inner join dokter on maping_dokter_antrian.kd_dokter=dokter.kd_dokter where "+
                   "maping_dokter_antrian.kd_dokter like ? or dokter.nm_dokter like ? or maping_dokter_antrian.kd_dokter_antrian like ? or maping_dokter_antrian.nm_dokter_antrian like ? order by dokter.nm_dokter");
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new Object[]{
                        rs.getString("kd_dokter"),rs.getString("nm_dokter"),rs.getString("kd_dokter_antrian"),rs.getString("nm_dokter_antrian")
                    });
                }
            } catch (Exception e) {
