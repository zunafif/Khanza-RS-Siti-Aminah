 ...
 * @author perpustakaan
 */
public class DlgTTDCatatanProgramTindakanRehabilitasi extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgTTDCatatanProgramTindakanRehabilitasi(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//        setSize(300,300);
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), ".:[ Tanda Tangan Hak dan Kewajiban ]:.", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Helvetica Neue", 0, 13), new java.awt.Color(70, 70, 70))); // NOI18N
        ...
        jLabel4.setBounds(200, 10, 65, 23);

        TNoRw.setEditable(false);
        TNoRw.setHighlighter(null);
        TNoRw.setName("TNoRw"); // NOI18N
        FormInput.add(TNoRw);
        TNoRw.setBounds(270, 10, 130, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        ...
        try {
            ...
            Logger.getLogger(DlgTTDCatatanProgramTindakanRehabilitasi.class.getName()).log(Level.SEVERE, null, ex);
        }
        Rectangle capture = 
            new Rectangle(Toolkit.getDefaultToolkit().getScreenSize());
            BufferedImage Image = r.createScreenCapture(panelGlass9.bounds());
        try {
            ImageIO.write(Image, "png", new File("tmpImageFreehand/ttdtindakanrehab"+TNoRM.getText()+""+TNoRw.getText().replaceAll("/", "")+".png"));
        } catch (IOException ex) {
            Logger.getLogger(DlgTTDCatatanProgramTindakanRehabilitasi.class.getName()).log(Level.SEVERE, null, ex);
        }
        uploadImage("ttdtindakanrehab"+TNoRM.getText()+""+TNoRw.getText().replaceAll("/", "")+".png","imagefreehand/tindakanrehab");
        dispose();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgTTDCatatanProgramTindakanRehabilitasi dialog = new DlgTTDCatatanProgramTindakanRehabilitasi(new javax.swing.JFrame(), true);
