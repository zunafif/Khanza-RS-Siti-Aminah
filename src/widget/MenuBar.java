...
public class MenuBar extends JMenuBar {
    ...
    private final Color light = new Color(153,255,153);
    private final Color dark = new Color(153,255,153);
    private final Color black = new Color(153,255,153);
    private final Color warna = new Color(153,255,153);
