...
public class ApiBSRE {        
    ...
    public ApiBSRE(){
        try {
            Username = koneksiDB.USERNAMEAPIBSRE();
            Password = koneksiDB.PASSWORDAPIBSRE();
        } catch (Exception ex) {
	...
	try {
	    generateHmacSHA256Signature = generateHmacSHA256Signature(salt,Username);
    ...
    public String Decrypt(String data,String utc)throws NoSuchPaddingException, NoSuchAlgorithmException, InvalidAlgorithmParameterException, InvalidKeyException, BadPaddingException, IllegalBlockSizeException {
        ...
        mykey = ApiBPJSEnc.generateKey(Password+Username+utc);
