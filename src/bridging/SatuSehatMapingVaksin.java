...
public final class SatuSehatMapingVaksin extends javax.swing.JDialog {
    ...
    private DlgCariVaksinSatuSehat vaksin=new DlgCariVaksinSatuSehat(null,false);
    private DlgCariRouteSatuSehat route=new DlgCariRouteSatuSehat(null,false);
    ...
    public SatuSehatMapingVaksin(java.awt.Frame parent, boolean modal) {
        ...
        barang.getTable().addKeyListener(new KeyListener() {
            ...
            public void keyReleased(KeyEvent e) {}
               ...
               route.addWindowListener(new WindowListener() {
            @Override
            public void windowOpened(WindowEvent e) {}
            @Override
            public void windowClosing(WindowEvent e) {}
            ...
            public void windowClosed(WindowEvent e) {
                if(route.getTable().getSelectedRow()!= -1){                    
                    ...
                    RouteSystem.setText(route.getTable().getValueAt(route.getTable().getSelectedRow(),1).toString());
                    RouteDisplay.setText(route.getTable().getValueAt(route.getTable().getSelectedRow(),2).toString());
        ...
        route.getTable().addKeyListener(new KeyListener() {
            @Override
            public void keyTyped(KeyEvent e) {}
            @Override
            public void keyPressed(KeyEvent e) {
        ...
        vaksin.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if(vaksin.getTable().getSelectedRow()!= -1){                    
                    VaksinCode.setText(vaksin.getTable().getValueAt(vaksin.getTable().getSelectedRow(),0).toString());
                    VaksinSystem.setText(vaksin.getTable().getValueAt(vaksin.getTable().getSelectedRow(),1).toString());
                    VaksinDisplay.setText(vaksin.getTable().getValueAt(vaksin.getTable().getSelectedRow(),2).toString());
    ...
    private void initComponents() {
        ...
        btnVaksin = new widget.Button();
        btnRoute = new widget.Button();
        btnDose = new widget.Button();
        ...
        btnBarang.setBounds(550, 10, 28, 23);
        ...
        jLabel10.setBounds(600, 10, 60, 23);
        ...
        VaksinDisplay.setBounds(660, 10, 140, 23);
        ...
        RouteSystem.setBounds(249, 40, 300, 23);
        ...
        RouteDisplay.setBounds(660, 40, 140, 23);

        jLabel12.setText("Route Display :");
        jLabel12.setName("jLabel12"); // NOI18N
        FormInput.add(jLabel12);
        jLabel12.setBounds(560, 40, 96, 23);

        jLabel13.setText("Dose Unit :");
        jLabel13.setName("jLabel13"); // NOI18N
        FormInput.add(jLabel13);
        jLabel13.setBounds(576, 70, 80, 23);
        ...
        DoseSystem.setBounds(249, 70, 300, 23);
        ...
        DoseUnit.setBounds(660, 70, 70, 23);
        ...
        btnVaksin.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/190.png"))); // NOI18N
        btnVaksin.setMnemonic('1');
        btnVaksin.setToolTipText("Alt+1");
        btnVaksin.setName("btnVaksin"); // NOI18N
        btnVaksin.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnVaksinActionPerformed(evt);
            }
        });
        btnVaksin.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                btnVaksinKeyPressed(evt);
            }
        });
        FormInput.add(btnVaksin);
        btnVaksin.setBounds(410, 10, 28, 23);
        ...
        btnRoute.setBounds(550, 40, 28, 23);

        btnDose.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/190.png"))); // NOI18N
        btnDose.setMnemonic('1');
        btnDose.setToolTipText("Alt+1");
        btnDose.setName("btnDose"); // NOI18N
        btnDose.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnDoseActionPerformed(evt);
            }
        });
        btnDose.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                btnDoseKeyPressed(evt);
            }
        });
        FormInput.add(btnDose);
        btnDose.setBounds(550, 70, 28, 23);
    ...
    private void btnVaksinActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVaksinActionPerformed
        vaksin.isCek();
        vaksin.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
        vaksin.setLocationRelativeTo(internalFrame1);
        vaksin.setVisible(true);        // TODO add your handling code here:
    }//GEN-LAST:event_btnVaksinActionPerformed

    private void btnVaksinKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_btnVaksinKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_btnVaksinKeyPressed
    ...
    private void btnDoseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDoseActionPerformed
     DoseSystem.setText("http://unitsofmeasure.org/");
    }//GEN-LAST:event_btnDoseActionPerformed

    private void btnDoseKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_btnDoseKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_btnDoseKeyPressed
    ...
    */
    ...
    private widget.Button btnDose;
    private widget.Button btnRoute;
    private widget.Button btnVaksin;
