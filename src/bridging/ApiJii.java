...
public class ApiJii {
    ...
    private Connection koneksi=koneksiDBJii.condb();
    ...
    public ApiJii(){
        super();
        try {
            URL = koneksiDBJii.URLJII();
            URLHASIL = koneksiDBJii.URLJII();
            UN = koneksiDBJii.UNJII();
            PW = koneksiDBJii.PWJII();
            id = koneksiDBJii.IDJII();
