...
public class DlgCariVaksinSatuSehat extends javax.swing.JDialog {
    ...
    public DlgCariVaksinSatuSehat(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Cari Vaksin Satu Sehat]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgCariVaksinSatuSehat dialog = new DlgCariVaksinSatuSehat(new javax.swing.JFrame(), true);
            ...
            try {
                if(TCari.getText().trim().equals("")){
                    ps = koneksi.prepareStatement(
                            "select * from satu_sehat_ref_vaksincode order by display asc limit " +cmbHlm.getSelectedItem().toString() + " ");

                }else{
                    ps = koneksi.prepareStatement(
                            "select * from satu_sehat_ref_vaksincode where satu_sehat_ref_vaksincode.display like ? order by satu_sehat_ref_vaksincode.display asc limit " +cmbHlm.getSelectedItem().toString() + " ");
                }
