 ...
 * @author dosen
 */
public final class DlgInstrumenOp extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgInstrumenOp(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.setLocation(10,10);
        setSize(545,599);

        tabMode=new DefaultTableModel(null,new Object[]{"P","Kode Instrumen","Nama Instrumen"}){
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Instrumen Operasi ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        jLabel3.setText("Kode Instrumen :");
        jLabel3.setName("jLabel3"); // NOI18N
        panelGlass8.add(jLabel3);
        jLabel3.setBounds(20, 10, 85, 23);
        ...
        jLabel4.setText("Nama Instrumen :");
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TKd.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("instrumen_ok","?,?","Kode Instrumen",2,new String[]{TKd.getText(),TNm.getText()})==true){
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        for(i=0;i<tbBangsal.getRowCount();i++){ 
            if(tbBangsal.getValueAt(i,0).toString().equals("true")){
                Sequel.meghapus("instrumen_ok","kd_instrumen",tbBangsal.getValueAt(tbBangsal.getSelectedRow(),1).toString()); 
                //Sequel.meghapus("instrumen_ok","kd_instrumen='"+tbBangsal.getValueAt(i,1).toString()+"'","status='0'");
                tabMode.removeRow(i);
                i--;
            }
        } 
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(TKd.getText().trim().equals("")){
            ...
            if(tbBangsal.getSelectedRow()>-1){
                if(Sequel.mengedittf("instrumen_ok","kd_instrumen=?","nm_instrumen=?,kd_instrumen=?",3,new String[]{TNm.getText(),TKd.getText(),tbBangsal.getValueAt(tbBangsal.getSelectedRow(), 1).toString()})==true){
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgInstrumenOp dialog = new DlgInstrumenOp(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement("select * from instrumen_ok where kd_instrumen like ? "+
    ...
    public void emptTeks() {
        ...
        TCari.setText("");
        TKd.requestFocus();
        Valid.autoNomer(" instrumen_ok ","OK",4,TKd);
    }
