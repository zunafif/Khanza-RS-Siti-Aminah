...
public final class DlgIGD extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        DTPReg.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "19-06-2026" }));
    ...
    private void MnCetakSuratMRSActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCetakSuratMRSActionPerformed
        if(tabMode.getRowCount()==0){
            ...
            if(tbPetugas.getSelectedRow()!= -1){
                ...
                surat.setNoRm(TNoRw.getText(),DTPCari2.getDate(),tbPetugas.getValueAt(tbPetugas.getSelectedRow(),5).toString(),tbPetugas.getValueAt(tbPetugas.getSelectedRow(),6).toString(),"IGDK");
                surat.tampil();
