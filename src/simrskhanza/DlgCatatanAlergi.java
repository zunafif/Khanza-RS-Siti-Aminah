 ...
 * @author perpustakaan
 */
public class DlgCatatanAlergi extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgCatatanAlergi(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Catatan Alergi Pasien ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRM.getText().trim().equals("")||TPasien.getText().trim().equals("")){
            ...
            Sequel.menyimpan3("catatan_pasien_alergi","?,?",2,new String[]{TNoRM.getText(),TCatatan.getText()},"no_rkm_medis=?","catatan=?",2,new String[]{TCatatan.getText(),TNoRM.getText()});
            BtnKeluarActionPerformed(evt);        
        }  
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
       Sequel.meghapus2("catatan_pasien_alergi","no_rkm_medis",TNoRM.getText());
       BtnKeluarActionPerformed(evt);       
...
private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
    if(TNoRM.getText().trim().equals("")||TPasien.getText().trim().equals("")){
        ...
        Sequel.mengedit2("catatan_pasien_alergi","no_rkm_medis=?","catatan=?",2,new String[]{
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgCatatanAlergi dialog = new DlgCatatanAlergi(new javax.swing.JFrame(), true);
    ...
    public void setNoRm(String norm) {
        TNoRM.setText(norm);  
        isPsien();   
        Sequel.cariIsi("select catatan_pasien_alergi.catatan from catatan_pasien_alergi where catatan_pasien_alergi.no_rkm_medis=?",TCatatan,TNoRM.getText());       
    }
    
    
    public void isCek(){
        BtnSimpan.setEnabled(akses.getcatatan_pasien());
        BtnHapus.setEnabled(akses.getcatatan_pasien());
        BtnEdit.setEnabled(akses.getcatatan_pasien());
