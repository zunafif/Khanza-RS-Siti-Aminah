...
import rekammedis.RMSuratMasukRS;
...
import rekammedis.RMLayananHemodialisa;
...
public final class DlgKasirRalan extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        MnPermintaanKFR = new javax.swing.JMenuItem();
        ...
        MnLayananHD = new javax.swing.JMenuItem();
        ...
        MnCetakSuratMRS = new javax.swing.JMenuItem();
        ...
        MnRehabMedik.setText("RM Rehab Medik");
        MnRehabMedik.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnRehabMedik.setName("MnRehabMedik"); // NOI18N

        MnLayananKedokteranFisikRehabilitasi.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnLayananKedokteranFisikRehabilitasi.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnLayananKedokteranFisikRehabilitasi.setText("Layanan Fisik & Rehabilitasi");
        MnLayananKedokteranFisikRehabilitasi.setName("MnLayananKedokteranFisikRehabilitasi"); // NOI18N
        MnLayananKedokteranFisikRehabilitasi.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnLayananKedokteranFisikRehabilitasiActionPerformed(evt);
            }
        });
        ...
        MnPermintaanKFR.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnPermintaanKFR.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnPermintaanKFR.setText("Permintaan Program KFR");
        MnPermintaanKFR.setName("MnPermintaanKFR"); // NOI18N
        MnPermintaanKFR.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnPermintaanKFRActionPerformed(evt);
            }
        });
        MnRehabMedik.add(MnPermintaanKFR);
        ...
        MnLayananHD.setBackground(new java.awt.Color(255, 255, 254));
        MnLayananHD.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnLayananHD.setForeground(new java.awt.Color(50, 50, 50));
        MnLayananHD.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnLayananHD.setText("Paket Pelayanan Hemodialisa");
        MnLayananHD.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnLayananHD.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnLayananHD.setName("MnLayananHD"); // NOI18N
        MnLayananHD.setPreferredSize(new java.awt.Dimension(210, 26));
        MnLayananHD.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnLayananHDActionPerformed(evt);
            }
        });
        MnPenilaianLain.add(MnLayananHD);
        ...
        MnSkriningTBC.setText("Skrining Pasien TBC");
        ...
        MnCetakSuratMRS.setBackground(new java.awt.Color(255, 255, 254));
        MnCetakSuratMRS.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnCetakSuratMRS.setForeground(new java.awt.Color(50, 50, 50));
        MnCetakSuratMRS.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnCetakSuratMRS.setText("Surat Masuk Rumah Sakit");
        MnCetakSuratMRS.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnCetakSuratMRS.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnCetakSuratMRS.setName("MnCetakSuratMRS"); // NOI18N
        MnCetakSuratMRS.setPreferredSize(new java.awt.Dimension(250, 26));
        MnCetakSuratMRS.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnCetakSuratMRSActionPerformed(evt);
            }
        });
        MnSuratSurat.add(MnCetakSuratMRS);
        ...
        TglSakit1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "30-06-2026" }));
        ...
        TglSakit2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "30-06-2026" }));
...
private boolean cekResepDuplikatDariKunjunganSebelumnya(String no_rawat_px) {
    boolean isPotensiPRB = false;
    
    try {
        Connection koneksi = koneksiDB.condb();
        
        // Step 1: Ambil no_rkm_medis dari no_rawat saat ini
        String sqlPasien = "SELECT no_rkm_medis FROM reg_periksa WHERE no_rawat = ?";
        PreparedStatement psPasien = koneksi.prepareStatement(sqlPasien);
        psPasien.setString(1, no_rawat_px);
        ResultSet rsPasien = psPasien.executeQuery();
        
        String no_rkm_medis = "";
        if (rsPasien.next()) {
            no_rkm_medis = rsPasien.getString("no_rkm_medis");
        }
        rsPasien.close();
        psPasien.close();
        
        if (no_rkm_medis.isEmpty()) {
            return false;
        }
        
        // Step 2: Ambil 3 kunjungan terakhir pasien
        String sqlKunjungan = "SELECT no_rawat, tgl_registrasi " +
                              "FROM reg_periksa " +
                              "WHERE no_rkm_medis = ? " +
                              "ORDER BY tgl_registrasi DESC, jam_reg DESC " +
                              "LIMIT 3";
        
        PreparedStatement psKunj = koneksi.prepareStatement(sqlKunjungan);
        psKunj.setString(1, no_rkm_medis);
        ResultSet rsKunj = psKunj.executeQuery();
        
        List<String> listNoRawat = new ArrayList<>();
        while (rsKunj.next()) {
            listNoRawat.add(rsKunj.getString("no_rawat"));
        }
        rsKunj.close();
        psKunj.close();
        ...
        // Step 3: Ambil SEMUA resep (per no_resep) dari masing-masing kunjungan
        // Map<no_rawat, Map<no_resep, List<ObatResep>>>
        Map<String, Map<String, List<ObatResep>>> resepPerKunjungan = new LinkedHashMap<>();
        
        String sqlResep = "SELECT ro.no_rawat, ro.no_resep, rd.kode_brng, b.nama_brng, rd.jml, rd.aturan_pakai " +
                          "FROM resep_obat ro " +
                          "INNER JOIN resep_dokter rd ON ro.no_resep = rd.no_resep " +
                          "INNER JOIN databarang b ON rd.kode_brng = b.kode_brng " +
                          "WHERE ro.no_rawat = ? " +
                          "ORDER BY ro.no_resep, rd.kode_brng";
        
        for (String nr : listNoRawat) {
            PreparedStatement psResep = koneksi.prepareStatement(sqlResep);
            psResep.setString(1, nr);
            ResultSet rsResep = psResep.executeQuery();
            
            Map<String, List<ObatResep>> resepMap = new HashMap<>();
            
            while (rsResep.next()) {
                String noResep = rsResep.getString("no_resep");
                String kodeBrng = rsResep.getString("kode_brng");
                String namaBrng = rsResep.getString("nama_brng");
                double jml = rsResep.getDouble("jml");
                String aturan = rsResep.getString("aturan_pakai");
                
                if (!resepMap.containsKey(noResep)) {
                    resepMap.put(noResep, new ArrayList<>());
                }
                resepMap.get(noResep).add(new ObatResep(kodeBrng, namaBrng, jml, aturan));
            }
            
            if (!resepMap.isEmpty()) {
                resepPerKunjungan.put(nr, resepMap);
            }
        ...
        // Step 4: Bandingkan SEMUA resep dari kunjungan A dengan SEMUA resep dari kunjungan B
        List<String> kunjunganKeys = new ArrayList<>(resepPerKunjungan.keySet());
        
        for (int i = 0; i < kunjunganKeys.size(); i++) {
            String rawatA = kunjunganKeys.get(i);
            Map<String, List<ObatResep>> resepKunjunganA = resepPerKunjungan.get(rawatA);
            
            for (int j = i + 1; j < kunjunganKeys.size(); j++) {
                String rawatB = kunjunganKeys.get(j);
                Map<String, List<ObatResep>> resepKunjunganB = resepPerKunjungan.get(rawatB);
                
                // Cek semua kombinasi resep antara kunjungan A dan B
                for (List<ObatResep> resepA : resepKunjunganA.values()) {
                    for (List<ObatResep> resepB : resepKunjunganB.values()) {
                        if (isResepIdentik(resepA, resepB)) {
                            isPotensiPRB = true;
                            System.out.println("Resep identik ditemukan antara " + rawatA + " dan " + rawatB);
                            break;
                        }
                    }
                    if (isPotensiPRB) break;
                }
                if (isPotensiPRB) break;
            }
            if (isPotensiPRB) break;
        ...
        System.out.println("Error cek resep duplikat: " + e.getMessage());
    }
    
    return isPotensiPRB;
}

private boolean isResepIdentik(List<ObatResep> resep1, List<ObatResep> resep2) {
    if (resep1 == null || resep2 == null) return false;
    if (resep1.size() != resep2.size()) return false;
    if (resep1.isEmpty()) return false;
    
    List<ObatResep> sorted1 = new ArrayList<>(resep1);
    List<ObatResep> sorted2 = new ArrayList<>(resep2);
    
    Collections.sort(sorted1, new Comparator<ObatResep>() {
        @Override
        public int compare(ObatResep o1, ObatResep o2) {
            return o1.kodeBrng.compareTo(o2.kodeBrng);
        }
    });
    
    Collections.sort(sorted2, new Comparator<ObatResep>() {
        @Override
        public int compare(ObatResep o1, ObatResep o2) {
            return o1.kodeBrng.compareTo(o2.kodeBrng);
        }
    ...
    for (int i = 0; i < sorted1.size(); i++) {
        ObatResep o1 = sorted1.get(i);
        ObatResep o2 = sorted2.get(i);
        
        if (!o1.kodeBrng.equals(o2.kodeBrng) ||
            o1.jml != o2.jml ||
            !o1.aturanPakai.equals(o2.aturanPakai)) {
            return false;
        }
    }
...
private class ObatResep {
    String kodeBrng;
    String namaBrng;
    String aturanPakai;
    double jml;
    
    ObatResep(String kodeBrng, String namaBrng, double jml, String aturanPakai) {
...
private void MnDataPemberianObatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnDataPemberianObatActionPerformed
    ...
    private void MnCetakSuratMRSActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCetakSuratMRSActionPerformed
        if(tabModekasir.getRowCount()==0){
            JOptionPane.showMessageDialog(null,"Maaf, data pasien sudah habis...!!!!");
            TNoRw.requestFocus();
        }else if(TPasienCari.getText().trim().equals("")){
            ...
            if(tbKasirRalan.getSelectedRow()!= -1){
                this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                RMSuratMasukRS surat=new RMSuratMasukRS(null,false);
                surat.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
                surat.setLocationRelativeTo(internalFrame1);
                surat.setNoRm(TNoRw.getText(),DTPCari2.getDate(),tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(),0).toString(),tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(),1).toString(),tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(),18).toString());
    ...
    }//GEN-LAST:event_MnCetakSuratMRSActionPerformed
    ...
    private void MnLayananKedokteranFisikRehabilitasiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnLayananKedokteranFisikRehabilitasiActionPerformed
        if(tabModekasir.getRowCount()==0){
            JOptionPane.showMessageDialog(null,"Maaf, table masih kosong...!!!!");
            //TNoReg.requestFocus();
        }else if(TNoRw.getText().trim().equals("")){
    ...
    }//GEN-LAST:event_MnLayananKedokteranFisikRehabilitasiActionPerformed

    private void MnPermintaanKFRActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPermintaanKFRActionPerformed
        if(tabModekasir.getRowCount()==0){
            JOptionPane.showMessageDialog(null,"Maaf, table masih kosong...!!!!");
            //TNoReg.requestFocus();
        }else if(TNoRw.getText().trim().equals("")){
            ...
            if(tbKasirRalan.getSelectedRow()!= -1){
                this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                DlgCariPermintaanLayananProgramKFR form=new DlgCariPermintaanLayananProgramKFR(null,false);
                form.isCek();
                form.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
                form.setLocationRelativeTo(internalFrame1);
                form.setVisible(true);
...
//                form.setNoRm(TNoRw.getText(),DTPCari2.getDate());
    ...
    }//GEN-LAST:event_MnPermintaanKFRActionPerformed
    ...
    private void MnDepositActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnDepositActionPerformed
        if(tabModekasir.getRowCount()==0){
            ...
            if(tbKasirRalan.getSelectedRow()>-1){
                ...
                billing.deposit.setNoRm(TNoRwCari.getText(),DTPCari1.getDate(),DTPCari2.getDate());
    ...
    private void MnLayananHDActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnLayananHDActionPerformed
        if(tabModekasir.getRowCount()==0){
            JOptionPane.showMessageDialog(null,"Maaf, data pasien sudah habis...!!!!");
            TNoRw.requestFocus();
        }else if(TPasienCari.getText().trim().equals("")){
            ...
            if(tbKasirRalan.getSelectedRow()!= -1){
                this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                RMLayananHemodialisa resume=new RMLayananHemodialisa(null,false);
                resume.emptTeks();
                resume.setNoRm(TNoRw.getText());
                resume.isCek();
                resume.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
    ...
    }//GEN-LAST:event_MnLayananHDActionPerformed
    ...
    */
    ...
    private javax.swing.JMenuItem MnCetakSuratMRS;
    ...
    private javax.swing.JMenuItem MnLayananHD;
    private javax.swing.JMenuItem MnLayananKedokteranFisikRehabilitasi;
    ...
    private javax.swing.JMenuItem MnPermintaanKFR;
    ...
    private javax.swing.JMenu MnRehabMedik;
    ...
    private javax.swing.JMenuItem MnPenilaianPreInduksi,MnHasilPemeriksaanUSGUrologi,MnHasilPemeriksaanUSGGynecologi,MnPaketMCU,MnJawabLembarKonsul,MnPemantauanIntradialitik,MnHasilPemeriksaanEcho,MnPenilaianPasienImunitasRendah,
            MnCatatanKeseimbanganCairan,MnCatatanObservasiCHBP,MnPenilaianAwalKeperawatanHemodialisa,MnLayananKedokteranFisikRehab;
...
//            antrianpasien.setText("NO.ANTRIAN");
    ...
    public void isCek(){
        ...
        MnCetakSuratMRS.setEnabled(akses.getsurat_keterangan_covid());
    ...
    private void initKasirRalan() {
        ...
        MnRMHemodialisa.add(MnLayananHD);
