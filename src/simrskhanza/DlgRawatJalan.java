...
public final class DlgRawatJalan extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        BtnOdontogram.setBounds(1280, 210, 105, 0);
        ...
        BtnTemplateResep.setBounds(1220, 380, 200, 30);
        ...
        BtnTemplatePemberianObat.setBounds(1220, 310, 200, 30);
        ...
        BtnTemplateResep1.setBounds(1110, 10, 160, 30);
        ...
        BtnTemplatePemberianObat1.setBounds(990, 320, 200, 30);
        ...
        Btn5Soap1.setBounds(920, 90, 160, 26);
        ...
        BtnHasilPengobatan.setBounds(920, 170, 160, 26);
        ...
        BtnHasilPengobatan1.setBounds(920, 210, 160, 26);
        ...
        BtnInputLAB.setBounds(1110, 50, 160, 26);
        ...
        BtnInputRAD.setBounds(1110, 90, 160, 26);
        ...
        BtnInputTerimaPasienAntarRuang.setBounds(1110, 170, 150, 26);
        ...
        BtnInputKonsul1.setBounds(920, 50, 160, 26);
        ...
        BtnTemplatePemberianObat2.setBounds(1110, 130, 200, 30);
        ...
        BtnDicom.setBounds(990, 390, 200, 26);
        ...
        BtnRiwayatFKTP.setBounds(920, 10, 160, 26);
        ...
        BtnResepRanap.setBounds(990, 360, 160, 26);

        RehabMedik.setForeground(new java.awt.Color(0, 0, 0));
        RehabMedik.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/Add patient.png"))); // NOI18N
        RehabMedik.setMnemonic('4');
        RehabMedik.setToolTipText("");
        RehabMedik.setActionCommand("Rehab Medik");
        RehabMedik.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        RehabMedik.setGlassColor(new java.awt.Color(255, 153, 153));
        RehabMedik.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        RehabMedik.setLabel("Rehab Medik");
        RehabMedik.setName("RehabMedik"); // NOI18N
        RehabMedik.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                RehabMedikActionPerformed(evt);
            }
        });
        panelGlass12.add(RehabMedik);
        RehabMedik.setBounds(1110, 210, 150, 30);
        ...
        DTPTgl.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "30-12-2025" }));
...
private void BtnEditKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnEditKeyPressed
    ...
    private void RehabMedikActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RehabMedikActionPerformed
        if(tbPemeriksaan.getSelectedRow()>-1){
            Map<String, Object> param = new HashMap<>();
            param.put("namars",akses.getnamars());
            param.put("alamatrs",akses.getalamatrs());
            ...
            param.put("logo",Sequel.cariGambar("select setting.logo from setting")); 
            Valid.MyReportqry(
    "rptSOAPRehabMedik.jasper",
    "report",
    "::[ Formulir SOAP Rehab Medik ]::",

    "SELECT " +
    "rp.no_rawat, ps.no_rkm_medis, ps.nm_pasien, rp.umurdaftar, rp.sttsumur, " +
    "IF(ps.jk='L','Laki-Laki','Perempuan') AS jk, ps.tgl_lahir, " +
    ...
    }//GEN-LAST:event_RehabMedikActionPerformed
    ...
    */
    ...
    private widget.Button RehabMedik;
