...
public final class DlgSensusHarianRalan extends javax.swing.JDialog {
    ...
    public DlgSensusHarianRalan(java.awt.Frame parent, boolean modal) {
        ...
        tabmode=new DefaultTableModel(null,new String[]{
                ...
                "J.K.","Rujukan Faskes Lain","Umur","Cara Bayar","Alamat","Diagnosa Utama",
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        try {            
            ...
            switch (pilihan){
                ...
                htmlContent.append(                             
                            "\"No.\";\"Nomor RM\";\"Nama Pasien\";\"Tgl Lahir\";\"Tgl Daftar\";\"Poliklinik\";\"Dokter\";\"JK\";\"Rujukan Faskes lain\";\"Umur\";\"Cara Bayar\";\"Alamat\";\"Diagnosa Utama\";\"Diagnosa Tambahan\";\"ICD X Utama\";\"ICD X Tambahan\";\"Tindakan\";\"Hasil Akhir\";\"Pengunjung\";\"Jenis Kunjungan\";\"Jenis Kasus\"\n"
                        ); 
                        if(TabRawat.getSelectedIndex()==0){
