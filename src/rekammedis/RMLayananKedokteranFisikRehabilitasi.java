...
public final class RMLayananKedokteranFisikRehabilitasi extends javax.swing.JDialog {
    ...
    public RMLayananKedokteranFisikRehabilitasi(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            ...
            "Diagnosis Fungsi (ICD - 10)","Tata Laksana KFR (ICD - 9 CM)","Pemeriksaan Penunjang","Anjuran",
            "Evaluasi","Suspek Akibat Kerja", "Keterangan Suspek Penyakit"
        }){
...
//        }
    ...
    private void initComponents() {
        ...
        BtnSubjek = new widget.Button();
        BtnObjek = new widget.Button();
        BtnEvaluasi = new widget.Button();
        BtnAssesmen = new widget.Button();
        BtnAssesmen2 = new widget.Button();
        BtnIntruksi = new widget.Button();
        BtnPlan = new widget.Button();
        ...
        jLabel103.setText("Diagnosis Medis :");
        jLabel103.setName("jLabel103"); // NOI18N
        FormInput.add(jLabel103);
        jLabel103.setBounds(30, 290, 220, 23);

        jLabel104.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel104.setText("Evaluasi (Rencana Waktu Tindak Lanjut) :");
        jLabel104.setName("jLabel104"); // NOI18N
        FormInput.add(jLabel104);
        jLabel104.setBounds(30, 660, 280, 23);
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "26-12-2025 12:58:37" }));
        ...
        jLabel105.setText("Diagnosis Fungsi :");
        ...
        jLabel106.setText("Tata Laksana KFR :");
        ...
        jLabel107.setText("Anjuran (Edukasi, Frekuensi Kunjungan, Lama Siklus dan Target Terapi Rehabilitasi):");
        jLabel107.setName("jLabel107"); // NOI18N
        FormInput.add(jLabel107);
        jLabel107.setBounds(30, 580, 490, 23);
        ...
        SuspekPenyakit.setBounds(180, 750, 80, 23);

        jLabel48.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel48.setText("Suspek Penyakit Akibat Kerja ");
        jLabel48.setName("jLabel48"); // NOI18N
        FormInput.add(jLabel48);
        jLabel48.setBounds(30, 750, 180, 23);
        ...
        KeteranganSuspekPenyakit.setBounds(260, 750, 609, 23);
        ...
        BtnSubjek.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/190.png"))); // NOI18N
        BtnSubjek.setMnemonic('2');
        BtnSubjek.setToolTipText("Alt+2");
        BtnSubjek.setName("BtnSubjek"); // NOI18N
        BtnSubjek.setPreferredSize(new java.awt.Dimension(28, 23));
        BtnSubjek.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnSubjekActionPerformed(evt);
            }
        });
        FormInput.add(BtnSubjek);
        BtnSubjek.setBounds(30, 130, 28, 23);

        BtnObjek.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/190.png"))); // NOI18N
        BtnObjek.setMnemonic('2');
        BtnObjek.setToolTipText("Alt+2");
        BtnObjek.setName("BtnObjek"); // NOI18N
        BtnObjek.setPreferredSize(new java.awt.Dimension(28, 23));
        BtnObjek.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnObjekActionPerformed(evt);
            }
        });
        FormInput.add(BtnObjek);
        BtnObjek.setBounds(30, 210, 28, 23);
        ...
        BtnEvaluasi.setBounds(30, 680, 28, 23);

        BtnAssesmen.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/190.png"))); // NOI18N
        BtnAssesmen.setMnemonic('2');
        BtnAssesmen.setToolTipText("Alt+2");
        BtnAssesmen.setName("BtnAssesmen"); // NOI18N
        BtnAssesmen.setPreferredSize(new java.awt.Dimension(28, 23));
        BtnAssesmen.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnAssesmenActionPerformed(evt);
            }
        });
        FormInput.add(BtnAssesmen);
        BtnAssesmen.setBounds(30, 310, 28, 23);

        BtnAssesmen2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/190.png"))); // NOI18N
        BtnAssesmen2.setMnemonic('2');
        BtnAssesmen2.setToolTipText("Alt+2");
        BtnAssesmen2.setName("BtnAssesmen2"); // NOI18N
        BtnAssesmen2.setPreferredSize(new java.awt.Dimension(28, 23));
        BtnAssesmen2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnAssesmen2ActionPerformed(evt);
            }
        });
        FormInput.add(BtnAssesmen2);
        BtnAssesmen2.setBounds(30, 380, 28, 23);

        BtnIntruksi.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/190.png"))); // NOI18N
        BtnIntruksi.setMnemonic('2');
        BtnIntruksi.setToolTipText("Alt+2");
        BtnIntruksi.setName("BtnIntruksi"); // NOI18N
        BtnIntruksi.setPreferredSize(new java.awt.Dimension(28, 23));
        BtnIntruksi.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnIntruksiActionPerformed(evt);
            }
        });
        FormInput.add(BtnIntruksi);
        BtnIntruksi.setBounds(30, 450, 28, 23);

        BtnPlan.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/190.png"))); // NOI18N
        BtnPlan.setMnemonic('2');
        BtnPlan.setToolTipText("Alt+2");
        BtnPlan.setName("BtnPlan"); // NOI18N
        BtnPlan.setPreferredSize(new java.awt.Dimension(28, 23));
        BtnPlan.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnPlanActionPerformed(evt);
            }
        });
        FormInput.add(BtnPlan);
        BtnPlan.setBounds(30, 600, 28, 23);
    ...
    private void MnLayananRehabActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnLayananRehabActionPerformed
        if(tbObat.getSelectedRow()>-1){
            ...
            Valid.MyReportqry(
    "rptCetakLayananKedokteranFisikRehabilitasi.jasper",
    "report",
    "::[ Lembar Formulir Layanan Rawat Jalan Kedokteran Fisik & Rehabilitasi ]::",
    ...
    "layanan_kedokteran_fisik_rehabilitasi.penunjang, " +
    ...
    "concat('http://" + koneksiDB.HOSTHYBRIDWEB() + ":" + koneksiDB.PORTWEB() + "/" +
         koneksiDB.HYBRIDWEB() + "/layanankedokteranfisikrehabilitasi/', " +
    "bukti_layanan_kedokteran_fisik_rehabilitasi.photo) AS photo, " +
    "poliklinik.nm_poli, pasien.alamat " +
    "FROM reg_periksa " +
    "INNER JOIN layanan_kedokteran_fisik_rehabilitasi " +
    "ON reg_periksa.no_rawat = layanan_kedokteran_fisik_rehabilitasi.no_rawat " +
    "LEFT JOIN bukti_layanan_kedokteran_fisik_rehabilitasi " +
    "ON bukti_layanan_kedokteran_fisik_rehabilitasi.no_rawat = layanan_kedokteran_fisik_rehabilitasi.no_rawat " +
    ...
    "WHERE layanan_kedokteran_fisik_rehabilitasi.no_rawat = '" +
    ...
    private void MnLayananProgramKFRActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnLayananProgramKFRActionPerformed
        if(tbObat.getSelectedRow()>-1){
            ...
            Valid.MyReportqry("rptFormulirLayananProgramKFR.jasper","report","::[ Formulir Layanan Program KFR ]::",
                ...
                "layanan_kedokteran_fisik_rehabilitasi.penunjang, layanan_program_kfr.program, layanan_program_kfr.nip,concat('http://"+koneksiDB.HOSTHYBRIDWEB()+":"+koneksiDB.PORTWEB()+"/"+koneksiDB.HYBRIDWEB()+"/layananprogramkfr/',bukti_layanan_program_kfr.photo) as photo, "+
    ...
    private void BtnSubjekActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSubjekActionPerformed
    ...
    private void BtnObjekActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnObjekActionPerformed
        if(TNoRw.getText().equals("")&&TNoRM.getText().equals("")){
            ...
            cariobjek.addWindowListener(new WindowListener() {
                ...
                public void windowClosed(WindowEvent e) {
                    if(cariobjek.getTable().getSelectedRow()!= -1){
                        PemeriksaanFisik.append(cariobjek.getTable().getValueAt(cariobjek.getTable().getSelectedRow(),2).toString()+", ");
            ...
            cariobjek.setNoRawat(TNoRw.getText());
            cariobjek.tampil();
            cariobjek.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
            cariobjek.setLocationRelativeTo(internalFrame1);
            cariobjek.setVisible(true);
    ...
    private void BtnEvaluasiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEvaluasiActionPerformed
        if(TNoRw.getText().equals("")&&TNoRM.getText().equals("")){
            ...
            RMCariEvaluasi carievaluasi=new RMCariEvaluasi(null,false);
            carievaluasi.addWindowListener(new WindowListener() {
                @Override
                public void windowOpened(WindowEvent e) {}
                @Override
                public void windowClosing(WindowEvent e) {}
                @Override
                public void windowClosed(WindowEvent e) {
                    if(carievaluasi.getTable().getSelectedRow()!= -1){
                        Evaluasi.append(carievaluasi.getTable().getValueAt(carievaluasi.getTable().getSelectedRow(),2).toString()+", ");
            ...
            carievaluasi.setNoRawat(TNoRw.getText());
            carievaluasi.tampil();
            carievaluasi.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
            carievaluasi.setLocationRelativeTo(internalFrame1);
            carievaluasi.setVisible(true);
        }// TODO add your handling code here:
    }//GEN-LAST:event_BtnEvaluasiActionPerformed

    private void BtnAssesmenActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnAssesmenActionPerformed
        if(TNoRw.getText().equals("")&&TNoRM.getText().equals("")){
            JOptionPane.showMessageDialog(null,"Pasien masih kosong...!!!");
        }else{
            RMCariAssesmen cariassesmen=new RMCariAssesmen(null,false);
            cariassesmen.addWindowListener(new WindowListener() {
                @Override
                public void windowOpened(WindowEvent e) {}
                @Override
                public void windowClosing(WindowEvent e) {}
                @Override
                public void windowClosed(WindowEvent e) {
                    if(cariassesmen.getTable().getSelectedRow()!= -1){
                        DiagnosisMedis.append(cariassesmen.getTable().getValueAt(cariassesmen.getTable().getSelectedRow(),2).toString()+", ");
                        DiagnosisMedis.requestFocus();
                    }
                }
                @Override
                public void windowIconified(WindowEvent e) {}
            ...
            cariassesmen.setNoRawat(TNoRw.getText());
            cariassesmen.tampil();
            cariassesmen.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
            cariassesmen.setLocationRelativeTo(internalFrame1);
            cariassesmen.setVisible(true);
        }// TODO add your handling code here:
    }//GEN-LAST:event_BtnAssesmenActionPerformed

    private void BtnAssesmen2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnAssesmen2ActionPerformed
        if(TNoRw.getText().equals("")&&TNoRM.getText().equals("")){
            JOptionPane.showMessageDialog(null,"Pasien masih kosong...!!!");
        }else{
            RMCariAssesmen cariassesmen=new RMCariAssesmen(null,false);
            cariassesmen.addWindowListener(new WindowListener() {
                ...
                public void windowClosed(WindowEvent e) {
                    if(cariassesmen.getTable().getSelectedRow()!= -1){
                        DiagnosisFungsi.append(cariassesmen.getTable().getValueAt(cariassesmen.getTable().getSelectedRow(),2).toString()+", ");
                        DiagnosisFungsi.requestFocus();
                    }
                }
                @Override
                public void windowIconified(WindowEvent e) {}
    ...
    }//GEN-LAST:event_BtnAssesmen2ActionPerformed

    private void BtnIntruksiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnIntruksiActionPerformed
        if(TNoRw.getText().equals("")&&TNoRM.getText().equals("")){
            JOptionPane.showMessageDialog(null,"Pasien masih kosong...!!!");
        }else{
            RMCariIntruksi cariintruksi=new RMCariIntruksi(null,false);
            cariintruksi.addWindowListener(new WindowListener() {
                @Override
                public void windowOpened(WindowEvent e) {}
                @Override
                public void windowClosing(WindowEvent e) {}
                @Override
                public void windowClosed(WindowEvent e) {
                    if(cariintruksi.getTable().getSelectedRow()!= -1){
                        TatalaksanaKFR.append(cariintruksi.getTable().getValueAt(cariintruksi.getTable().getSelectedRow(),2).toString()+", ");
                        TatalaksanaKFR.requestFocus();
                    }
                }
                @Override
                public void windowIconified(WindowEvent e) {}
            ...
            cariintruksi.setNoRawat(TNoRw.getText());
            cariintruksi.tampil();
            cariintruksi.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
            cariintruksi.setLocationRelativeTo(internalFrame1);
            cariintruksi.setVisible(true);
        }// TODO add your handling code here:
    }//GEN-LAST:event_BtnIntruksiActionPerformed

    private void BtnPlanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPlanActionPerformed
        if(TNoRw.getText().equals("")&&TNoRM.getText().equals("")){
            JOptionPane.showMessageDialog(null,"Pasien masih kosong...!!!");
        }else{
            RMCariPlan cariplan=new RMCariPlan(null,false);
            cariplan.addWindowListener(new WindowListener() {
                @Override
                public void windowOpened(WindowEvent e) {}
                @Override
                public void windowClosing(WindowEvent e) {}
                @Override
                public void windowClosed(WindowEvent e) {
                    if(cariplan.getTable().getSelectedRow()!= -1){
                        Anjuran.append(cariplan.getTable().getValueAt(cariplan.getTable().getSelectedRow(),2).toString()+", ");
    ...
    */
    ...
    private widget.Button BtnAssesmen;
    private widget.Button BtnAssesmen2;
    ...
    private widget.Button BtnIntruksi;
    private widget.Button BtnKeluar;
    private widget.Button BtnObjek;
    private widget.Button BtnPlan;
    private widget.Button BtnPrint;
    private widget.Button BtnRefreshPhoto1;
    private widget.Button BtnSimpan;
    private widget.Button BtnSubjek;
            ...
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new Object[]{
                        ...
                        rs.getString("tatalaksana"),rs.getString("penunjang"),rs.getString("anjuran"),rs.getString("evaluasi"),rs.getString("suspek_penyakit_kerja"),rs.getString("keterangan_suspek_penyakit_kerja")                     
                    });
                }
            } catch (Exception e) {
...
//            Treatment.setText(tbObat.getValueAt(tbObat.getSelectedRow(),19).toString());
            SuspekPenyakit.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),18).toString());
            KeteranganSuspekPenyakit.setText(tbObat.getValueAt(tbObat.getSelectedRow(),19).toString());
    ...
    private void ganti() {
        if(Sequel.mengedittf("layanan_kedokteran_fisik_rehabilitasi","no_rawat=?","no_rawat=?,tanggal=?,kd_dokter=?,pendamping=?,keterangan_pendamping=?,anamnesa=?,pemeriksaan_fisik=?,diagnosa_medis=?,diagnosa_fungsi=?,tatalaksana=?,penunjang=?,anjuran=?,evaluasi=?,suspek_penyakit_kerja=?,keterangan_suspek_penyakit_kerja=?",15,new String[]{
                ...
                DiagnosisFungsi.getText(),TatalaksanaKFR.getText(),Penunjang.getText(),Anjuran.getText(),Evaluasi.getText(),SuspekPenyakit.getSelectedItem().toString(), 
...
//                tbObat.setValueAt(Treatment.getText(),tbObat.getSelectedRow(),19);
                tbObat.setValueAt(SuspekPenyakit.getSelectedItem().toString(),tbObat.getSelectedRow(),18);
                tbObat.setValueAt(KeteranganSuspekPenyakit.getText(),tbObat.getSelectedRow(),19);
                emptTeks();
                TabRawat.setSelectedIndex(1);
        }
    }
    ...
    private void simpan() {
        if(Sequel.menyimpantf("layanan_kedokteran_fisik_rehabilitasi","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,'Belum Selesai'","No.Rawat",15,new String[]{
                TNoRw.getText(),Valid.SetTgl(TglAsuhan.getSelectedItem()+"")+" "+TglAsuhan.getSelectedItem().toString().substring(11,19),KdDokter.getText(),
                Pendamping.getSelectedItem().toString(),KeteranganPendamping.getText(),Anamnesa.getText(),PemeriksaanFisik.getText(),DiagnosisMedis.getText(), 
                DiagnosisFungsi.getText(),TatalaksanaKFR.getText(),Penunjang.getText(),Anjuran.getText(),Evaluasi.getText(),SuspekPenyakit.getSelectedItem().toString(), 
                ...
                tabMode.addRow(new Object[]{
                    ...
                    Penunjang.getText(),Anjuran.getText(),Evaluasi.getText(),SuspekPenyakit.getSelectedItem().toString(),KeteranganSuspekPenyakit.getText()
                });
                emptTeks();
                LCount.setText(""+tabMode.getRowCount());
        }
