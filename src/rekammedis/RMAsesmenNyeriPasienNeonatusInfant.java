 ...
 * @author perpustakaan
 */
public final class RMAsesmenNyeriPasienNeonatusInfant extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public RMAsesmenNyeriPasienNeonatusInfant(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Asesmen Nyeri Pasien Neonatus dan Infant ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        SkalaResiko4.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Relaks", "Fleksi" }));
        ...
        SkalaResiko5.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Otot Tidak Kaku", "Fleksi" }));
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRw.getText().trim().equals("")||TPasien.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("asesmen_nyeri_neonatus_infant","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","Data",18,new String[]{
        ...
        if(tabMode.getRowCount()==0){
            ...
            if(TCari.getText().trim().equals("")){
                Valid.MyReportqry("rptLanjutanRisikoJatuhDewasa.jasper","report","::[ Data Penilaian Lanjutan Risiko Jatuh Dewasa ]::",
                    "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,pasien.jk,pasien.tgl_lahir,asesmen_nyeri_neonatus_infant.tanggal,"+
                    "asesmen_nyeri_neonatus_infant.penilaian_jatuhmorse_skala1,asesmen_nyeri_neonatus_infant.penilaian_jatuhmorse_nilai1,"+
                    "asesmen_nyeri_neonatus_infant.penilaian_jatuhmorse_skala2,asesmen_nyeri_neonatus_infant.penilaian_jatuhmorse_nilai2,"+
                    "asesmen_nyeri_neonatus_infant.penilaian_jatuhmorse_skala3,asesmen_nyeri_neonatus_infant.penilaian_jatuhmorse_nilai3,"+
                    "asesmen_nyeri_neonatus_infant.penilaian_jatuhmorse_skala4,asesmen_nyeri_neonatus_infant.penilaian_jatuhmorse_nilai4,"+
                    "asesmen_nyeri_neonatus_infant.penilaian_jatuhmorse_skala5,asesmen_nyeri_neonatus_infant.penilaian_jatuhmorse_nilai5,"+
                    "asesmen_nyeri_neonatus_infant.penilaian_jatuhmorse_skala6,asesmen_nyeri_neonatus_infant.penilaian_jatuhmorse_nilai6,"+
                    "asesmen_nyeri_neonatus_infant.penilaian_jatuhmorse_totalnilai,asesmen_nyeri_neonatus_infant.hasil_skrining,"+
                    "asesmen_nyeri_neonatus_infant.saran,asesmen_nyeri_neonatus_infant.nip,petugas.nama "+
                    "from asesmen_nyeri_neonatus_infant inner join reg_periksa on asesmen_nyeri_neonatus_infant.no_rawat=reg_periksa.no_rawat "+
                    "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "inner join petugas on asesmen_nyeri_neonatus_infant.nip=petugas.nip where "+
                    "asesmen_nyeri_neonatus_infant.tanggal between '"+Valid.SetTgl(DTPCari1.getSelectedItem()+"")+" 00:00:00' and '"+Valid.SetTgl(DTPCari2.getSelectedItem()+"")+" 23:59:59' "+
                    "order by asesmen_nyeri_neonatus_infant.tanggal",param);
            }else{
                Valid.MyReportqry("rptLanjutanRisikoJatuhDewasa.jasper","report","::[ Data Penilaian Lanjutan Risiko Jatuh Dewasa ]::",
                    "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,pasien.jk,pasien.tgl_lahir,asesmen_nyeri_neonatus_infant.tanggal,"+
                    "asesmen_nyeri_neonatus_infant.penilaian_jatuhmorse_skala1,asesmen_nyeri_neonatus_infant.penilaian_jatuhmorse_nilai1,"+
                    ...
                    "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "inner join petugas on asesmen_nyeri_neonatus_infant.nip=petugas.nip where "+
                    "asesmen_nyeri_neonatus_infant.tanggal between '"+Valid.SetTgl(DTPCari1.getSelectedItem()+"")+" 00:00:00' and '"+Valid.SetTgl(DTPCari2.getSelectedItem()+"")+" 23:59:59' and "+
                    ...
                    "or asesmen_nyeri_neonatus_infant.nip like '%"+TCari.getText().trim()+"%' or petugas.nama like '%"+TCari.getText().trim()+"%') "+
                    "order by asesmen_nyeri_neonatus_infant.tanggal ",param);
            }  
        }
    ...
    private void MnPenilaianLanjutanRisikoJatuhActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPenilaianLanjutanRisikoJatuhActionPerformed
        if(tbObat.getSelectedRow()>-1){
            ...
            Valid.MyReportqry("rptRMAsesmenNyeriPasienNeonatusInfant.jasper","report","::[ Formulir Asesmen Nyeri Pasien Neonatus Infant ]::",
                    ...
                    "from asesmen_nyeri_neonatus_infant inner join reg_periksa on asesmen_nyeri_neonatus_infant.no_rawat=reg_periksa.no_rawat "+
                    "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "inner join petugas on asesmen_nyeri_neonatus_infant.nip=petugas.nip where reg_periksa.no_rawat='"+tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()+"'",param);
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMAsesmenNyeriPasienNeonatusInfant dialog = new RMAsesmenNyeriPasienNeonatusInfant(new javax.swing.JFrame(), true);
        ...
        try{
            if(TCari.getText().toString().trim().equals("")){
                ps=koneksi.prepareStatement(
                    ...
                    "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "inner join petugas on asesmen_nyeri_neonatus_infant.nip=petugas.nip where "+
                    "asesmen_nyeri_neonatus_infant.tanggal between ? and ? order by asesmen_nyeri_neonatus_infant.tanggal");
            }else{
                ps=koneksi.prepareStatement(
                    "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,pasien.jk,pasien.tgl_lahir,asesmen_nyeri_neonatus_infant.tanggal,"+
                    "asesmen_nyeri_neonatus_infant.penilaian_jatuhmorse_skala1,asesmen_nyeri_neonatus_infant.penilaian_jatuhmorse_nilai1,"+
                    ...
                    "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "inner join petugas on asesmen_nyeri_neonatus_infant.nip=petugas.nip where "+
                    "asesmen_nyeri_neonatus_infant.tanggal between ? and ? and (reg_periksa.no_rawat like ? or pasien.no_rkm_medis like ? or pasien.nm_pasien like ? or asesmen_nyeri_neonatus_infant.nip like ? or petugas.nama like ?) "+
                    "order by asesmen_nyeri_neonatus_infant.tanggal ");
            }
    ...
    private void ganti() {
        Sequel.mengedit("asesmen_nyeri_neonatus_infant","tanggal=? and no_rawat=?","no_rawat=?,tanggal=?,penilaian_jatuhmorse_skala1=?,penilaian_jatuhmorse_nilai1=?,"+
    ...
    private void hapus() {
        if(Sequel.queryu2tf("delete from asesmen_nyeri_neonatus_infant where tanggal=? and no_rawat=?",2,new String[]{
    ...
    private void isTotalResikoJatuh(){
        try {
            ...
            if(Integer.parseInt(NilaiResikoTotal.getText())==0){
                TingkatResiko.setText("Tingkat Nyeri : Tidak Nyeri (0), Tindakan : ");
            }else if(Integer.parseInt(NilaiResikoTotal.getText())==1){
                TingkatResiko.setText("Tingkat Nyeri : Nyeri Ringan (1-2), Tindakan : ");
            }else if(Integer.parseInt(NilaiResikoTotal.getText())==2){
                TingkatResiko.setText("Tingkat Nyeri : Nyeri Ringan (1-2), Tindakan : ");
            }else if(Integer.parseInt(NilaiResikoTotal.getText())==3){
                TingkatResiko.setText("Tingkat Nyeri : Nyeri Sedang (3-4), Tindakan : Intervensi non farmakologi dengan reasesmen setiap 30 menit ");
            }else if(Integer.parseInt(NilaiResikoTotal.getText())==4){
                TingkatResiko.setText("Tingkat Nyeri : Nyeri Sedang (3-4), Tindakan : Intervensi non farmakologi dengan reasesmen setiap 30 menit ");
            }else if(Integer.parseInt(NilaiResikoTotal.getText())>4){
                TingkatResiko.setText("Tingkat Nyeri : Nyeri Berat (3-4), Tindakan : Intervensi non farmakologis dan mungkin intervensi farmakologi dengan reasesmen setiap 30 menit");
            }
        } catch (Exception e) {
            NilaiResikoTotal.setText("0");
            TingkatResiko.setText("Berikan intervensi sesuai nyeri");
        }
    }
}
