 ...
 * @author dosen
 */
public final class RMCari5SOAPTerakhirAdime extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public RMCari5SOAPTerakhirAdime(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.setLocation(10,2);
        setSize(656,250);

        Object[] row={"Tanggal","Jam","Asesmen","Diagnosis","Intervensi","Monitoring","Evaluasi","Instruksi PPA"};
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMCari5SOAPTerakhirAdime dialog = new RMCari5SOAPTerakhirAdime(new javax.swing.JFrame(), true);
