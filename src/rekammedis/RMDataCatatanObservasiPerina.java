 ...
 * @author perpustakaan
 */
public final class RMDataCatatanObservasiPerina extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public RMDataCatatanObservasiPerina(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        MnCatatanObservasiIGD.setText("Formulir Catatan Observasi Perina");
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Catatan Observasi Perina ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRw.getText().trim().equals("")||TPasien.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("catatan_observasi_perina","?,?,?,?,?,?,?,?,?,?","Data",10,new String[]{
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            if(TCari.getText().trim().equals("")){
                Valid.MyReportqry("rptDataCatatanObservasiPerina.jasper","report","::[ Data Catatan Observasi Perina ]::",
                    "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,reg_periksa.umurdaftar,reg_periksa.sttsumur,"+
                    "pasien.jk,pasien.tgl_lahir,catatan_observasi_perina.tgl_perawatan,catatan_observasi_perina.jam_rawat,catatan_observasi_perina.gcs,"+
                    "catatan_observasi_perina.td,catatan_observasi_perina.hr,catatan_observasi_perina.rr,catatan_observasi_perina.suhu,catatan_observasi_perina.spo2,"+
                    "catatan_observasi_perina.nip,petugas.nama from catatan_observasi_perina inner join reg_periksa on catatan_observasi_perina.no_rawat=reg_periksa.no_rawat "+
                    "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "inner join petugas on catatan_observasi_perina.nip=petugas.nip where "+
                    "catatan_observasi_perina.tgl_perawatan between '"+Valid.SetTgl(DTPCari1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(DTPCari2.getSelectedItem()+"")+"' order by catatan_observasi_perina.tgl_perawatan",param);
            }else{
                Valid.MyReportqry("rptDataCatatanObservasiPerina.jasper","report","::[ Data Catatan Observasi Perina ]::",
                    "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,reg_periksa.umurdaftar,reg_periksa.sttsumur,"+
                    "pasien.jk,pasien.tgl_lahir,catatan_observasi_perina.tgl_perawatan,catatan_observasi_perina.jam_rawat,catatan_observasi_perina.gcs,"+
                    ...
                    "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "inner join petugas on catatan_observasi_perina.nip=petugas.nip where "+
                    "catatan_observasi_perina.tgl_perawatan between '"+Valid.SetTgl(DTPCari1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(DTPCari2.getSelectedItem()+"")+"' and "+
                    "(reg_periksa.no_rawat like '%"+TCari.getText().trim()+"%' or pasien.no_rkm_medis like '%"+TCari.getText().trim()+"%' or "+
                    "pasien.nm_pasien like '%"+TCari.getText().trim()+"%' or catatan_observasi_perina.nip like '%"+TCari.getText().trim()+"%' or petugas.nama like '%"+TCari.getText().trim()+"%') "+
                    "order by catatan_observasi_perina.tgl_perawatan ",param);
            }  
        }
    ...
    private void MnCatatanObservasiIGDActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCatatanObservasiIGDActionPerformed
        if(tbObat.getSelectedRow()>-1){
            ...
            param.put("dpjp",dpjp);   
            param.put("logo",Sequel.cariGambar("select setting.logo from setting")); 
            Valid.MyReportqry("rptFormulirCatatanObservasiPerina.jasper","report","::[ Formulir Catatan Observasi Perina ]::",
                    ...
                    "pasien.jk,pasien.tgl_lahir,catatan_observasi_perina.tgl_perawatan,catatan_observasi_perina.jam_rawat,catatan_observasi_perina.gcs,"+
                    "catatan_observasi_perina.td,catatan_observasi_perina.hr,catatan_observasi_perina.rr,catatan_observasi_perina.suhu,catatan_observasi_perina.spo2,"+
                    "petugas.nama from catatan_observasi_perina inner join reg_periksa on catatan_observasi_perina.no_rawat=reg_periksa.no_rawat "+
                    "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "inner join petugas on catatan_observasi_perina.nip=petugas.nip where reg_periksa.no_rawat='"+tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()+"'",param);
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMDataCatatanObservasiPerina dialog = new RMDataCatatanObservasiPerina(new javax.swing.JFrame(), true);
        ...
        try{
            if(TCari.getText().toString().trim().equals("")){
                ps=koneksi.prepareStatement(
                    ...
                    "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "inner join petugas on catatan_observasi_perina.nip=petugas.nip where "+
                    "catatan_observasi_perina.tgl_perawatan between ? and ? order by catatan_observasi_perina.tgl_perawatan");
            }else{
                ps=koneksi.prepareStatement(
                    "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,reg_periksa.umurdaftar,reg_periksa.sttsumur,"+
                    "pasien.jk,pasien.tgl_lahir,catatan_observasi_perina.tgl_perawatan,catatan_observasi_perina.jam_rawat,catatan_observasi_perina.gcs,"+
                    ...
                    "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "inner join petugas on catatan_observasi_perina.nip=petugas.nip where "+
                    "catatan_observasi_perina.tgl_perawatan between ? and ? and (reg_periksa.no_rawat like ? or pasien.no_rkm_medis like ? or pasien.nm_pasien like ? or catatan_observasi_perina.nip like ? or petugas.nama like ?) "+
                    "order by catatan_observasi_perina.tgl_perawatan ");
            }
    ...
    private void ganti() {
        Sequel.mengedit("catatan_observasi_perina","tgl_perawatan=? and jam_rawat=? and no_rawat=?","no_rawat=?,tgl_perawatan=?,jam_rawat=?,gcs=?,td=?,hr=?,rr=?,suhu=?,spo2=?,nip=?",13,new String[]{
            TNoRw.getText(),Valid.SetTgl(Tanggal.getSelectedItem()+""),Jam.getSelectedItem()+":"+Menit.getSelectedItem()+":"+Detik.getSelectedItem(),
    ...
    private void hapus() {
        if(Sequel.queryu2tf("delete from catatan_observasi_perina where tgl_perawatan=? and jam_rawat=? and no_rawat=?",3,new String[]{
