 ...
 * @author perpustakaan
 */
public final class AsesmenNyeriPasienInfantNIPS extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public AsesmenNyeriPasienInfantNIPS(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            "No.Rawat","No.R.M.","Nama Pasien","Tgl.Lahir","JK","Tanggal","Ekspresi Wajah","Temuan",
            "Menangis","Temuan","Pola Pernafasan","Temuan","Lengan","Temuan","Kaki","Temuan",
            "Kesadaran","Temuan","Total","Hasil Skrining","Saran","NIP","Petugas"
        }){
        ...
        HasilSkrining.setDocument(new batasInput((int)1000).getKata(HasilSkrining));
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Monitoring Nyeri Pasien Neonatus Skala NIPS ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        Tanggal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "04-10-2023" }));
        ...
        jLabel57.setText("Temuan :");
        jLabel57.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel57.setName("jLabel57"); // NOI18N
        FormInput.add(jLabel57);
        jLabel57.setBounds(330, 70, 80, 23);
        ...
        SkalaResiko3.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Bernafas Relaks", "Pola Nafas Berubah-Ubah" }));
        ...
        SkalaResiko4.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Relaks/Terikat", "Fleksi/Ekstensi" }));
        ...
        SkalaResiko5.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Relaks/Terikat", "Fleksi/Ekstensi" }));
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRw.getText().trim().equals("")||TPasien.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("asesmen_nyeri_infant_nips","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","Data",18,new String[]{
        ...
        if(tabMode.getRowCount()==0){
            ...
            if(TCari.getText().trim().equals("")){
                Valid.MyReportqry("rptLanjutanRisikoJatuhDewasa.jasper","report","::[ Data Penilaian Lanjutan Risiko Jatuh Dewasa ]::",
                    "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,pasien.jk,pasien.tgl_lahir,asesmen_nyeri_infant_nips.tanggal,"+
                    "asesmen_nyeri_infant_nips.penilaian_jatuhmorse_skala1,asesmen_nyeri_infant_nips.penilaian_jatuhmorse_nilai1,"+
                    "asesmen_nyeri_infant_nips.penilaian_jatuhmorse_skala2,asesmen_nyeri_infant_nips.penilaian_jatuhmorse_nilai2,"+
                    "asesmen_nyeri_infant_nips.penilaian_jatuhmorse_skala3,asesmen_nyeri_infant_nips.penilaian_jatuhmorse_nilai3,"+
                    "asesmen_nyeri_infant_nips.penilaian_jatuhmorse_skala4,asesmen_nyeri_infant_nips.penilaian_jatuhmorse_nilai4,"+
                    "asesmen_nyeri_infant_nips.penilaian_jatuhmorse_skala5,asesmen_nyeri_infant_nips.penilaian_jatuhmorse_nilai5,"+
                    "asesmen_nyeri_infant_nips.penilaian_jatuhmorse_skala6,asesmen_nyeri_infant_nips.penilaian_jatuhmorse_nilai6,"+
                    "asesmen_nyeri_infant_nips.penilaian_jatuhmorse_totalnilai,asesmen_nyeri_infant_nips.hasil_skrining,"+
                    "asesmen_nyeri_infant_nips.saran,asesmen_nyeri_infant_nips.nip,petugas.nama "+
                    "from asesmen_nyeri_infant_nips inner join reg_periksa on asesmen_nyeri_infant_nips.no_rawat=reg_periksa.no_rawat "+
                    "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "inner join petugas on asesmen_nyeri_infant_nips.nip=petugas.nip where "+
                    "asesmen_nyeri_infant_nips.tanggal between '"+Valid.SetTgl(DTPCari1.getSelectedItem()+"")+" 00:00:00' and '"+Valid.SetTgl(DTPCari2.getSelectedItem()+"")+" 23:59:59' "+
                    "order by asesmen_nyeri_infant_nips.tanggal",param);
            }else{
                Valid.MyReportqry("rptLanjutanRisikoJatuhDewasa.jasper","report","::[ Data Penilaian Lanjutan Risiko Jatuh Dewasa ]::",
                    "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,pasien.jk,pasien.tgl_lahir,asesmen_nyeri_infant_nips.tanggal,"+
                    "asesmen_nyeri_infant_nips.penilaian_jatuhmorse_skala1,asesmen_nyeri_infant_nips.penilaian_jatuhmorse_nilai1,"+
                    ...
                    "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "inner join petugas on asesmen_nyeri_infant_nips.nip=petugas.nip where "+
                    "asesmen_nyeri_infant_nips.tanggal between '"+Valid.SetTgl(DTPCari1.getSelectedItem()+"")+" 00:00:00' and '"+Valid.SetTgl(DTPCari2.getSelectedItem()+"")+" 23:59:59' and "+
                    ...
                    "or asesmen_nyeri_infant_nips.nip like '%"+TCari.getText().trim()+"%' or petugas.nama like '%"+TCari.getText().trim()+"%') "+
                    "order by asesmen_nyeri_infant_nips.tanggal ",param);
            }  
        }
    ...
    private void MnPenilaianLanjutanRisikoJatuhActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPenilaianLanjutanRisikoJatuhActionPerformed
        if(tbObat.getSelectedRow()>-1){
            ...
            Valid.MyReportqry("rptRMAsesmenNyeriPasienNeonatusInfant.jasper","report","::[ Formulir Asesmen Nyeri Pasien Neonatus Infant ]::",
                    ...
                    "from asesmen_nyeri_infant_nips inner join reg_periksa on asesmen_nyeri_infant_nips.no_rawat=reg_periksa.no_rawat "+
                    "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "inner join petugas on asesmen_nyeri_infant_nips.nip=petugas.nip where reg_periksa.no_rawat='"+tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()+"'",param);
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            AsesmenNyeriPasienInfantNIPS dialog = new AsesmenNyeriPasienInfantNIPS(new javax.swing.JFrame(), true);
        ...
        try{
            if(TCari.getText().toString().trim().equals("")){
                ps=koneksi.prepareStatement(
                    ...
                    "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "inner join petugas on asesmen_nyeri_infant_nips.nip=petugas.nip where "+
                    "asesmen_nyeri_infant_nips.tanggal between ? and ? order by asesmen_nyeri_infant_nips.tanggal");
            }else{
                ps=koneksi.prepareStatement(
                    "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,pasien.jk,pasien.tgl_lahir,asesmen_nyeri_infant_nips.tanggal,"+
                    "asesmen_nyeri_infant_nips.penilaian_jatuhmorse_skala1,asesmen_nyeri_infant_nips.penilaian_jatuhmorse_nilai1,"+
                    ...
                    "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "inner join petugas on asesmen_nyeri_infant_nips.nip=petugas.nip where "+
                    "asesmen_nyeri_infant_nips.tanggal between ? and ? and (reg_periksa.no_rawat like ? or pasien.no_rkm_medis like ? or pasien.nm_pasien like ? or asesmen_nyeri_infant_nips.nip like ? or petugas.nama like ?) "+
                    "order by asesmen_nyeri_infant_nips.tanggal ");
            }
    ...
    private void ganti() {
        Sequel.mengedit("asesmen_nyeri_infant_nips","tanggal=? and no_rawat=?","no_rawat=?,tanggal=?,penilaian_jatuhmorse_skala1=?,penilaian_jatuhmorse_nilai1=?,"+
    ...
    private void hapus() {
        if(Sequel.queryu2tf("delete from asesmen_nyeri_infant_nips where tanggal=? and no_rawat=?",2,new String[]{
    ...
    private void isTotalResikoJatuh(){
        try {
            ...
            if(Integer.parseInt(NilaiResikoTotal.getText())==0){
                HasilSkrining.setText("Tingkat Nyeri : Tidak Nyeri (0-1)");
            }else if(Integer.parseInt(NilaiResikoTotal.getText())==1){
                HasilSkrining.setText("Tingkat Nyeri : Tidak Nyeri (0-1)");
            }else if(Integer.parseInt(NilaiResikoTotal.getText())==2){
                HasilSkrining.setText("Tingkat Nyeri : Skala Ringan (2), Tindakan : intervensi non farmakologis dilakukan + assessment ulang 60 menit kemudian ");
            }else if(Integer.parseInt(NilaiResikoTotal.getText())==3){
                HasilSkrining.setText("Tingkat Nyeri : Skala Sedang (3-4), Tindakan : intervensi non farmakologis dilakukan \n"+
                        " assessment ulang 60 menit kemudian ");
            }else if(Integer.parseInt(NilaiResikoTotal.getText())==4){
                HasilSkrining.setText("Tingkat Nyeri : Skala Sedang (3-4), Tindakan : intervensi non farmakologis dilakukan \n"+ 
                        " assessment ulang 60 menit kemudian ");
            }else if(Integer.parseInt(NilaiResikoTotal.getText())>=5){
                HasilSkrining.setText("Tingkat Nyeri : Skala Berat (5-7), Tindakan : intervensi farmakologis dilakukan \n"+ 
                        "intervensi non farmakologis dilakukan + assessment ulang 30 menit kemudian) *Observasi efek samping obat intravena 5 menit setelah injeksi");
            }
        } catch (Exception e) {
            NilaiResikoTotal.setText("0");
            HasilSkrining.setText("");
