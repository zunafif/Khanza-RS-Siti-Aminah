 ...
 * @author perpustakaan
 */
public final class RMSuratMRSPenuh extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public RMSuratMRSPenuh(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Konfirmasi Kamar Penuh ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        TglLahir.setBounds(689, 10, 140, 23);

        jLabel12.setText("Petugas :");
        jLabel12.setName("jLabel12"); // NOI18N
        FormInput.add(jLabel12);
        jLabel12.setBounds(480, 100, 50, 23);
        ...
        NoSurat.setBounds(490, 40, 340, 23);

        Tindakan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Pasien Akan di RUJUK", "Pasien tetap di IGD dengan surat pernyataan", "Mohon untuk didaftarkan sebagai Pasien Daftar Tunggu / Reservasi" }));
        ...
        Tindakan.setBounds(90, 100, 370, 23);

        NoKamar.setFocusTraversalPolicyProvider(true);
        NoKamar.setName("NoKamar"); // NOI18N
        NoKamar.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                NoKamarActionPerformed(evt);
            }
        });
        NoKamar.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                NoKamarKeyPressed(evt);
            }
        });
        FormInput.add(NoKamar);
        NoKamar.setBounds(730, 70, 100, 23);

        jLabel13.setText("Asal MRS :");
        jLabel13.setName("jLabel13"); // NOI18N
        FormInput.add(jLabel13);
        jLabel13.setBounds(20, 100, 60, 23);

        jLabel14.setText("No. :");
        jLabel14.setName("jLabel14"); // NOI18N
        FormInput.add(jLabel14);
        jLabel14.setBounds(680, 70, 40, 23);

        Kelas.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "VIP", "Kelas 1", "Kelas 2", "Kelas 3" }));
        ...
        FormInput.add(Kelas);
        Kelas.setBounds(590, 70, 80, 23);

        jLabel17.setText("Ruang yang Penuh :");
        jLabel17.setName("jLabel17"); // NOI18N
        FormInput.add(jLabel17);
        jLabel17.setBounds(10, 70, 110, 23);

        jLabel20.setText("Pasien akan dirawat di :");
        jLabel20.setName("jLabel20"); // NOI18N
        FormInput.add(jLabel20);
        jLabel20.setBounds(240, 70, 130, 23);

        Ruang.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "VIP", "Isolasi", "ICU", "Perinatologi", "Kelas 1", "Kelas 2", "Kelas 3" }));
        ...
        FormInput.add(Kamar);
        Kamar.setBounds(380, 70, 150, 23);

        jLabel15.setText("No. Surat :");
        jLabel15.setName("jLabel15"); // NOI18N
        FormInput.add(jLabel15);
        jLabel15.setBounds(420, 40, 60, 23);
        ...
        FormInput.add(NIP);
        NIP.setBounds(540, 100, 94, 23);

        NamaPetugas.setEditable(false);
        NamaPetugas.setName("NamaPetugas"); // NOI18N
        FormInput.add(NamaPetugas);
        NamaPetugas.setBounds(640, 100, 187, 23);
        ...
        btnPetugas.setBounds(830, 100, 28, 23);

        PanelInput.add(FormInput);
        FormInput.setBounds(0, 0, 967, 140);
        ...
        PanelInput.add(ChkInput);
        ChkInput.setBounds(0, 140, 967, 20);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRw.getText().trim().equals("")||TPasien.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("surat_mrs_penuh","?,?,?,?,?,?,?,?","Data",8,new String[]{
                TNoRw.getText(),
                ...
                NoKamar.getText(),
                Tindakan.getSelectedItem().toString(),
                NIP.getText()
            })==true){
                tampil();
    ...
    private void NoKamarKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_NoKamarKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_NoKamarKeyPressed
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMSuratMRSPenuh dialog = new RMSuratMRSPenuh(new javax.swing.JFrame(), true);
    ...
    private widget.TextBox NoKamar;
        ...
        try{
            if(TCari.getText().toString().trim().equals("")){
                ps=koneksi.prepareStatement(
                    ...
                    "  pasien.tgl_lahir,\n" +
                    "  pasien.pekerjaan,\n" +
                    "  surat_mrs_penuh.tanggal,\n" +
                    "  TIME(surat_mrs_penuh.tanggal) AS jam,  -- ← Ambil jam saja\n" +
                    "  surat_mrs.no_surat,\n" +
                    "  surat_mrs_penuh.ruang_penuh,\n" +
                    "  surat_mrs_penuh.kamar,\n" +
                    "  surat_mrs_penuh.kelas,\n" +
                    "  surat_mrs_penuh.no_kamar,\n" +
                    "  surat_mrs_penuh.nip,\n" +
                    "  pegawai.nama,\n" +
                    "  surat_mrs_penuh.tindakan\n" +
                    "FROM\n" +
                    "  surat_mrs_penuh\n" +
                    "  JOIN reg_periksa ON surat_mrs_penuh.no_rawat = reg_periksa.no_rawat\n" +
                    "  JOIN surat_mrs ON surat_mrs_penuh.no_rawat = surat_mrs.no_rawat\n" +
                    "  JOIN pasien ON reg_periksa.no_rkm_medis = pasien.no_rkm_medis\n" +
                    "  JOIN pegawai ON surat_mrs_penuh.nip = pegawai.nik\n" +
                    "WHERE tanggal BETWEEN ? AND ? ORDER BY surat_mrs_penuh.tanggal DESC");
            }else{
                ps=koneksi.prepareStatement(
                    "SELECT\n" +
                    "  surat_mrs_penuh.no_rawat,\n" +
                    ...
                    "  JOIN pegawai ON surat_mrs_penuh.nip = pegawai.nik\n" +
                    "WHERE\n" +
                    "  surat_mrs_penuh.tanggal BETWEEN ? AND ?" +
                    "  AND (\n" +
            ...
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new String[]{
                        ...
                        rs.getString("pekerjaan"),rs.getString("tanggal"),rs.getString("jam"),rs.getString("no_surat"),
                        rs.getString("ruang_penuh"),rs.getString("kamar"),rs.getString("kelas"),rs.getString("no_kamar"),
    ...
    private void getData() {
        if(tbObat.getSelectedRow() != -1){
            ...
            // 11 - Dirawat di Ruang
            Kelas.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 11).toString());

            // 13 - No Kelas
            NoKamar.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 13).toString());

            // 14 - Tindakan Lanjut
            Tindakan.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 14).toString());

            // 7 - Tanggal Konfirmasi (format: yyyy-MM-dd)
    ...
    public void setNoRm(String norwt, Date tgl2, String nosurat) {
        TNoRw.setText(norwt);
        TCari.setText(norwt);
    ...
    private void ganti() {
        if(Sequel.mengedittf("surat_mrs_penuh","no_rawat=?","tanggal=?,ruang_penuh=?,kamar=?,kelas=?,no_kamar=?,tindakan=?",7,new String[]{
            Valid.SetTgl(Tanggal.getSelectedItem()+"")+" "+Jam.getSelectedItem()+":"+Menit.getSelectedItem()+":"+Detik.getSelectedItem(),
            Ruang.getSelectedItem().toString(),
            Kamar.getText(),
            Kelas.getSelectedItem().toString(),
    ...
    private void hapus() {
        if(Sequel.queryu2tf("delete from surat_mrs_penuh where no_rawat=?",1,new String[]{
