 ...
 * @author perpustakaan
 */
public final class AsesmenKhususKebidananIbuNifas_1 extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public AsesmenKhususKebidananIbuNifas_1(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            AsesmenKhususKebidananIbuNifas_1 dialog = new AsesmenKhususKebidananIbuNifas_1(new javax.swing.JFrame(), true);
