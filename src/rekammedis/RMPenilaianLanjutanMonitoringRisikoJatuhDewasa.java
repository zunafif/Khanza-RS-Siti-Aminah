 ...
 * @author perpustakaan
 */
public final class RMPenilaianLanjutanMonitoringRisikoJatuhDewasa extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public RMPenilaianLanjutanMonitoringRisikoJatuhDewasa(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            "No.Rawat","No.R.M.","Nama Pasien","Tgl.Lahir","JK","Tanggal","Langkah 1",
            "Langkah 2","Langkah 3","Langkah 4","Langkah 5","Langkah 6","Langkah 7","Langkah 8",
            "Langkah 9","Langkah 10","Langkah 11","Langkah 12","Langkah 13","Langkah 14","Catatan","NIP","Petugas"
        }){
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Lembar Monitoring Pencegahan Jatuh ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        FormInput.setPreferredSize(new java.awt.Dimension(1200, 400));
        ...
        Tanggal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "09-06-2023" }));
        ...
        jLabel57.setText("Langkah-Langkah");
        ...
        jLabel217.setText("2. Memberi penanda resiko jatuh digelang dan tempat tidur pasien");
        jLabel217.setName("jLabel217"); // NOI18N
        FormInput.add(jLabel217);
        jLabel217.setBounds(30, 120, 500, 23);

        SkalaResiko1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak", "Ya", "Menolak" }));
        ...
        SkalaResiko1.setBounds(410, 90, 90, 23);

        jLabel220.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel220.setText("1. Melakukan orientasi ruangan kepada pasien dan keluarga");
        jLabel220.setName("jLabel220"); // NOI18N
        FormInput.add(jLabel220);
        jLabel220.setBounds(30, 90, 500, 23);

        SkalaResiko2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak", "Ya", "Menolak" }));
        ...
        SkalaResiko2.setBounds(410, 120, 90, 23);

        jLabel223.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel223.setText("6. Mengkaji adanya tumpahan/genangan di lantai");
        jLabel223.setName("jLabel223"); // NOI18N
        FormInput.add(jLabel223);
        jLabel223.setBounds(30, 260, 500, 23);

        SkalaResiko3.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak", "Ya", "Menolak" }));
        ...
        SkalaResiko3.setBounds(410, 150, 90, 23);

        jLabel226.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel226.setText("9. Mendekatkan barang-barang pasien agar mudah dijangkau");
        jLabel226.setName("jLabel226"); // NOI18N
        FormInput.add(jLabel226);
        jLabel226.setBounds(520, 120, 440, 23);

        SkalaResiko4.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak", "Ya", "Menolak" }));
        ...
        SkalaResiko4.setBounds(410, 190, 90, 23);

        SkalaResiko5.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak", "Ya", "Menolak" }));
        ...
        SkalaResiko5.setBounds(410, 230, 90, 23);

        SkalaResiko6.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak", "Ya", "Menolak" }));
        ...
        SkalaResiko6.setBounds(410, 260, 90, 23);

        jLabel30.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel30.setText("Catatan :");
        jLabel30.setName("jLabel30"); // NOI18N
        FormInput.add(jLabel30);
        jLabel30.setBounds(30, 350, 50, 23);
        ...
        scrollPane1.setBounds(30, 370, 1100, 60);
        ...
        jLabel235.setText("5. Menempatkan posisi tempat tidur serendah mungkin");
        jLabel235.setName("jLabel235"); // NOI18N
        jLabel235.setPreferredSize(new java.awt.Dimension(129, 14));
        FormInput.add(jLabel235);
        jLabel235.setBounds(30, 230, 500, 23);

        SkalaResiko7.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak", "Ya", "Menolak" }));
        ...
        SkalaResiko7.setBounds(410, 290, 90, 23);

        jLabel240.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel240.setText("10. Menyarankan pasien untuk memakai alas kaki yang tidak licin");
        jLabel240.setName("jLabel240"); // NOI18N
        jLabel240.setPreferredSize(new java.awt.Dimension(129, 14));
        FormInput.add(jLabel240);
        jLabel240.setBounds(520, 150, 440, 23);

        SkalaResiko8.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak", "Ya", "Menolak" }));
        ...
        SkalaResiko8.setBounds(1040, 90, 90, 23);

        SkalaResiko9.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak", "Ya", "Menolak" }));
        ...
        SkalaResiko9.setBounds(1040, 120, 90, 23);

        jLabel241.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel241.setText("pasien setiap akan turun dari tempat tidur atau berjalan ke kamar mandi");
        jLabel241.setName("jLabel241"); // NOI18N
        jLabel241.setPreferredSize(new java.awt.Dimension(129, 14));
        FormInput.add(jLabel241);
        jLabel241.setBounds(30, 170, 500, 20);

        SkalaResiko10.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak", "Ya", "Menolak" }));
        ...
        SkalaResiko11.setBounds(1040, 180, 90, 23);

        SkalaResiko12.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak", "Ya", "Menolak" }));
        ...
        SkalaResiko12.setBounds(1040, 210, 90, 23);

        SkalaResiko13.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak", "Ya", "Menolak" }));
        ...
        SkalaResiko13.setBounds(1040, 260, 90, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRw.getText().trim().equals("")||TPasien.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("lembar_monitoring_resiko_jatuh_dewasa","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","Data",18,new String[]{
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMPenilaianLanjutanMonitoringRisikoJatuhDewasa dialog = new RMPenilaianLanjutanMonitoringRisikoJatuhDewasa(new javax.swing.JFrame(), true);
        ...
        try{
            if(TCari.getText().toString().trim().equals("")){
                ps=koneksi.prepareStatement(
                    "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,pasien.jk,pasien.tgl_lahir,lembar_monitoring_resiko_jatuh_dewasa.tanggal,"+
                    "lembar_monitoring_resiko_jatuh_dewasa.penilaian_jatuhmorse_skala1,"+
                    "lembar_monitoring_resiko_jatuh_dewasa.penilaian_jatuhmorse_skala2,"+
                    "lembar_monitoring_resiko_jatuh_dewasa.penilaian_jatuhmorse_skala3,"+
                    "lembar_monitoring_resiko_jatuh_dewasa.penilaian_jatuhmorse_skala4,"+
                    "lembar_monitoring_resiko_jatuh_dewasa.penilaian_jatuhmorse_skala5,"+
                    "lembar_monitoring_resiko_jatuh_dewasa.penilaian_jatuhmorse_skala6,"+
                    "lembar_monitoring_resiko_jatuh_dewasa.penilaian_jatuhmorse_skala7,"+
                    "lembar_monitoring_resiko_jatuh_dewasa.penilaian_jatuhmorse_skala8,"+
                    "lembar_monitoring_resiko_jatuh_dewasa.penilaian_jatuhmorse_skala9,"+
                    "lembar_monitoring_resiko_jatuh_dewasa.penilaian_jatuhmorse_skala10,"+
                    "lembar_monitoring_resiko_jatuh_dewasa.penilaian_jatuhmorse_skala11,"+
                    "lembar_monitoring_resiko_jatuh_dewasa.penilaian_jatuhmorse_skala12,"+
                    "lembar_monitoring_resiko_jatuh_dewasa.penilaian_jatuhmorse_skala13,"+
                    "lembar_monitoring_resiko_jatuh_dewasa.penilaian_jatuhmorse_skala14,"+
                    "lembar_monitoring_resiko_jatuh_dewasa.hasil_skrining,"+
                    "lembar_monitoring_resiko_jatuh_dewasa.nip,petugas.nama "+
                    "from lembar_monitoring_resiko_jatuh_dewasa inner join reg_periksa on lembar_monitoring_resiko_jatuh_dewasa.no_rawat=reg_periksa.no_rawat "+
                    "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "inner join petugas on lembar_monitoring_resiko_jatuh_dewasa.nip=petugas.nip where "+
                    "lembar_monitoring_resiko_jatuh_dewasa.tanggal between ? and ? order by lembar_monitoring_resiko_jatuh_dewasa.tanggal");
            }else{
                ps=koneksi.prepareStatement(
                    "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,pasien.jk,pasien.tgl_lahir,lembar_monitoring_resiko_jatuh_dewasa.tanggal,"+
                    "lembar_monitoring_resiko_jatuh_dewasa.penilaian_jatuhmorse_skala1,"+
                    ...
                    "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "inner join petugas on lembar_monitoring_resiko_jatuh_dewasa.nip=petugas.nip where "+
                    "lembar_monitoring_resiko_jatuh_dewasa.tanggal between ? and ? and (reg_periksa.no_rawat like ? or pasien.no_rkm_medis like ? or pasien.nm_pasien like ? or lembar_monitoring_resiko_jatuh_dewasa.nip like ? or petugas.nama like ?) "+
                    "order by lembar_monitoring_resiko_jatuh_dewasa.tanggal ");
            }
    ...
    private void isForm(){
        if(ChkInput.isSelected()==true){
            if(internalFrame1.getHeight()>350){
                ...
                ChkInput.setText(".: Tampilkan Data :.");
    ...
    private void ganti() {
        Sequel.mengedit("lembar_monitoring_resiko_jatuh_dewasa","tanggal=? and no_rawat=?","no_rawat=?,tanggal=?,"+
            ...
            "penilaian_jatuhmorse_skala10=?,penilaian_jatuhmorse_skala11=?,penilaian_jatuhmorse_skala12=?,penilaian_jatuhmorse_skala13=?,penilaian_jatuhmorse_skala14=?,"+
            "hasil_skrining=?,nip=?",20,new String[]{
            TNoRw.getText(),Valid.SetTgl(Tanggal.getSelectedItem()+"")+" "+Jam.getSelectedItem()+":"+Menit.getSelectedItem()+":"+Detik.getSelectedItem(),
            SkalaResiko1.getSelectedItem().toString(),SkalaResiko2.getSelectedItem().toString(),
            SkalaResiko3.getSelectedItem().toString(),SkalaResiko4.getSelectedItem().toString(), 
            SkalaResiko5.getSelectedItem().toString(),SkalaResiko6.getSelectedItem().toString(),
    ...
    private void hapus() {
        if(Sequel.queryu2tf("delete from lembar_monitoring_resiko_jatuh_dewasa where tanggal=? and no_rawat=?",2,new String[]{
