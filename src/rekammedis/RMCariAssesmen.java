 ...
 * @author dosen
 */
public final class RMCariAssesmen extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public RMCariAssesmen(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.setLocation(10,2);
        setSize(656,250);

        Object[] row={"Tanggal","Jam","Assesmen"};
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMCariAssesmen dialog = new RMCariAssesmen(new javax.swing.JFrame(), true);
