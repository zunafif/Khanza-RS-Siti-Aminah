 ...
 * @author perpustakaan
 */
public final class RMAsesmenNyeriPasienDewasaAnakFLACC extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public RMAsesmenNyeriPasienDewasaAnakFLACC(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            "No.Rawat","No.R.M.","Nama Pasien","Tgl.Lahir","JK","Tanggal","Wajah","Temuan",
            "Menangis","Temuan","Kaki","Temuan","Aktifitas","Temuan","Bersuara","Temuan",
...
//        HasilSkrining.setDocument(new batasInput((int)200).getKata(HasilSkrining));
    ...
    private void initComponents() {
        ...
        MnPenilaianLanjutanRisikoJatuh.setText("Form Asesmen Nyeri Pasien Neonatus Infant");
        ...
        Tanggal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "02-10-2023" }));
        ...
        SkalaResiko2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak menangis (bangun/tidur)\t", "Mengerang, merengek-rengek", "Menangis terus-menerus, terisak, menjerit" }));
        ...
        jLabel223.setText("3. Kaki");
        jLabel223.setName("jLabel223"); // NOI18N
        FormInput.add(jLabel223);
        jLabel223.setBounds(34, 150, 260, 23);

        SkalaResiko3.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Gerakan normal / relaksasi", "Tidak tenang / tegang", "Kaki dibuat menendang / menarik diri" }));
        ...
        jLabel226.setText("4. Aktifitas");
        jLabel226.setName("jLabel226"); // NOI18N
        FormInput.add(jLabel226);
        jLabel226.setBounds(34, 180, 260, 23);

        SkalaResiko4.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidur, posisi normal, mudah bergerak", "Gerakan menggeliat, berguling, kaku", "Melengkungkan punggung / kaku / menghentak" }));
        ...
        SkalaResiko5.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Bersuara normal, tenang", "Tenang bila dipeluk, digendong atau diajak bicara", "Sulit menenangkan" }));
        ...
        TingkatResiko.setText("Tingkat Resiko : Berikan intervensi sesuai risiko");
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRw.getText().trim().equals("")||TPasien.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("asesmen_nyeri_dewasa_anak_flacc","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","Data",16,new String[]{
...
//                    "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,pasien.jk,pasien.tgl_lahir,asesmen_nyeri_dewasa_anak_flacc.tanggal,"+
//                    "asesmen_nyeri_dewasa_anak_flacc.penilaian_jatuhmorse_skala1,asesmen_nyeri_dewasa_anak_flacc.penilaian_jatuhmorse_nilai1,"+
//                    "asesmen_nyeri_dewasa_anak_flacc.penilaian_jatuhmorse_skala2,asesmen_nyeri_dewasa_anak_flacc.penilaian_jatuhmorse_nilai2,"+
//                    "asesmen_nyeri_dewasa_anak_flacc.penilaian_jatuhmorse_skala3,asesmen_nyeri_dewasa_anak_flacc.penilaian_jatuhmorse_nilai3,"+
//                    "asesmen_nyeri_dewasa_anak_flacc.penilaian_jatuhmorse_skala4,asesmen_nyeri_dewasa_anak_flacc.penilaian_jatuhmorse_nilai4,"+
//                    "asesmen_nyeri_dewasa_anak_flacc.penilaian_jatuhmorse_skala5,asesmen_nyeri_dewasa_anak_flacc.penilaian_jatuhmorse_nilai5,"+
//                    "asesmen_nyeri_dewasa_anak_flacc.penilaian_jatuhmorse_skala6,asesmen_nyeri_dewasa_anak_flacc.penilaian_jatuhmorse_nilai6,"+
//                    "asesmen_nyeri_dewasa_anak_flacc.penilaian_jatuhmorse_totalnilai,asesmen_nyeri_dewasa_anak_flacc.hasil_skrining,"+
//                    "asesmen_nyeri_dewasa_anak_flacc.saran,asesmen_nyeri_dewasa_anak_flacc.nip,petugas.nama "+
//                    "from asesmen_nyeri_dewasa_anak_flacc inner join reg_periksa on asesmen_nyeri_dewasa_anak_flacc.no_rawat=reg_periksa.no_rawat "+
//                    "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
//                    "inner join petugas on asesmen_nyeri_dewasa_anak_flacc.nip=petugas.nip where "+
//                    "asesmen_nyeri_dewasa_anak_flacc.tanggal between '"+Valid.SetTgl(DTPCari1.getSelectedItem()+"")+" 00:00:00' and '"+Valid.SetTgl(DTPCari2.getSelectedItem()+"")+" 23:59:59' "+
//                    "order by asesmen_nyeri_dewasa_anak_flacc.tanggal",param);
//            }else{
//                Valid.MyReportqry("rptLanjutanRisikoJatuhDewasa.jasper","report","::[ Data Penilaian Lanjutan Risiko Jatuh Dewasa ]::",
//                    "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,pasien.jk,pasien.tgl_lahir,asesmen_nyeri_dewasa_anak_flacc.tanggal,"+
//                    "asesmen_nyeri_dewasa_anak_flacc.penilaian_jatuhmorse_skala1,asesmen_nyeri_dewasa_anak_flacc.penilaian_jatuhmorse_nilai1,"+
...
//                    "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
//                    "inner join petugas on asesmen_nyeri_dewasa_anak_flacc.nip=petugas.nip where "+
//                    "asesmen_nyeri_dewasa_anak_flacc.tanggal between '"+Valid.SetTgl(DTPCari1.getSelectedItem()+"")+" 00:00:00' and '"+Valid.SetTgl(DTPCari2.getSelectedItem()+"")+" 23:59:59' and "+
...
//                    "or asesmen_nyeri_dewasa_anak_flacc.nip like '%"+TCari.getText().trim()+"%' or petugas.nama like '%"+TCari.getText().trim()+"%') "+
//                    "order by asesmen_nyeri_dewasa_anak_flacc.tanggal ",param);
//            }  
//        }
...
//            Valid.MyReportqry("rptRMAsesmenNyeriPasienNeonatusInfant.jasper","report","::[ Formulir Asesmen Nyeri Pasien Neonatus Infant ]::",
//                    "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,pasien.jk,pasien.tgl_lahir,asesmen_nyeri_dewasa_anak_flacc.tanggal,"+
//                    "asesmen_nyeri_dewasa_anak_flacc.penilaian_jatuhmorse_skala1,asesmen_nyeri_dewasa_anak_flacc.penilaian_jatuhmorse_nilai1,"+
//                    "asesmen_nyeri_dewasa_anak_flacc.penilaian_jatuhmorse_skala2,asesmen_nyeri_dewasa_anak_flacc.penilaian_jatuhmorse_nilai2,"+
//                    "asesmen_nyeri_dewasa_anak_flacc.penilaian_jatuhmorse_skala3,asesmen_nyeri_dewasa_anak_flacc.penilaian_jatuhmorse_nilai3,"+
...
//                    "from asesmen_nyeri_dewasa_anak_flacc inner join reg_periksa on asesmen_nyeri_dewasa_anak_flacc.no_rawat=reg_periksa.no_rawat "+
//                    "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
//                    "inner join petugas on asesmen_nyeri_dewasa_anak_flacc.nip=petugas.nip where reg_periksa.no_rawat='"+tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()+"'",param);
//        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMAsesmenNyeriPasienDewasaAnakFLACC dialog = new RMAsesmenNyeriPasienDewasaAnakFLACC(new javax.swing.JFrame(), true);
        ...
        try{
            if(TCari.getText().toString().trim().equals("")){
                ps=koneksi.prepareStatement(
                    ...
                    "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "inner join petugas on asesmen_nyeri_dewasa_anak_flacc.nip=petugas.nip where "+
                    "asesmen_nyeri_dewasa_anak_flacc.tanggal between ? and ? order by asesmen_nyeri_dewasa_anak_flacc.tanggal");
            }else{
                ps=koneksi.prepareStatement(
                    "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,pasien.jk,pasien.tgl_lahir,asesmen_nyeri_dewasa_anak_flacc.tanggal,"+
                    "asesmen_nyeri_dewasa_anak_flacc.penilaian_jatuhmorse_skala1,asesmen_nyeri_dewasa_anak_flacc.penilaian_jatuhmorse_nilai1,"+
                    ...
                    "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "inner join petugas on asesmen_nyeri_dewasa_anak_flacc.nip=petugas.nip where "+
                    "asesmen_nyeri_dewasa_anak_flacc.tanggal between ? and ? and (reg_periksa.no_rawat like ? or pasien.no_rkm_medis like ? or pasien.nm_pasien like ? or asesmen_nyeri_dewasa_anak_flacc.nip like ? or petugas.nama like ?) "+
                    "order by asesmen_nyeri_dewasa_anak_flacc.tanggal ");
            }
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            HasilSkrining.setText(tbObat.getValueAt(tbObat.getSelectedRow(),17).toString());
            Saran.setText(tbObat.getValueAt(tbObat.getSelectedRow(),18).toString());
    ...
    private void ganti() {
        Sequel.mengedit("asesmen_nyeri_dewasa_anak_flacc","tanggal=? and no_rawat=?","no_rawat=?,tanggal=?,penilaian_jatuhmorse_skala1=?,penilaian_jatuhmorse_nilai1=?,"+
            ...
            "penilaian_jatuhmorse_nilai4=?,penilaian_jatuhmorse_skala5=?,penilaian_jatuhmorse_nilai5=?,"+
            "penilaian_jatuhmorse_totalnilai=?,hasil_skrining=?,saran=?,nip=?",18,new String[]{
            TNoRw.getText(),Valid.SetTgl(Tanggal.getSelectedItem()+"")+" "+Jam.getSelectedItem()+":"+Menit.getSelectedItem()+":"+Detik.getSelectedItem(),
            SkalaResiko1.getSelectedItem().toString(),NilaiResiko1.getText(),SkalaResiko2.getSelectedItem().toString(),NilaiResiko2.getText(),
            SkalaResiko3.getSelectedItem().toString(),NilaiResiko3.getText(),SkalaResiko4.getSelectedItem().toString(),NilaiResiko4.getText(), 
            SkalaResiko5.getSelectedItem().toString(),NilaiResiko5.getText(),
    ...
    private void hapus() {
        if(Sequel.queryu2tf("delete from asesmen_nyeri_dewasa_anak_flacc where tanggal=? and no_rawat=?",2,new String[]{
    ...
    private void isTotalResikoJatuh(){
        try {
            ...
            if(Integer.parseInt(NilaiResikoTotal.getText())==0){
                TingkatResiko.setText("Tingkat Nyeri : Nyaman (0)");
            }else if(Integer.parseInt(NilaiResikoTotal.getText())==1){
                TingkatResiko.setText("Tingkat Nyeri : Kurang Nyaman (1-3)");
            }else if(Integer.parseInt(NilaiResikoTotal.getText())==2){
                TingkatResiko.setText("Tingkat Nyeri : Kurang Nyaman (1-3)");
            }else if(Integer.parseInt(NilaiResikoTotal.getText())==3){
                TingkatResiko.setText("Tingkat Nyeri : Kurang Nyaman (1-3)");
            }else if(Integer.parseInt(NilaiResikoTotal.getText())==4){
                TingkatResiko.setText("Tingkat Nyeri : Nyeri Sedang (4-6)");
                ...
                TingkatResiko.setText("Tingkat Nyeri : Nyeri Berat (7-10)");
            }
        } catch (Exception e) {
            NilaiResikoTotal.setText("0");
