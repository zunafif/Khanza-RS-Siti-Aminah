 ...
 * @author dosen
 */
public final class RMCariEvaluasi extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public RMCariEvaluasi(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.setLocation(10,2);
        setSize(656,250);

        Object[] row={"Tanggal","Jam","Evaluasi"};
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMCariEvaluasi dialog = new RMCariEvaluasi(new javax.swing.JFrame(), true);
    ...
    public void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement(
                    "select pemeriksaan_ralan.tgl_perawatan,pemeriksaan_ralan.jam_rawat,pemeriksaan_ralan.evaluasi "+
        ...
        try{
            ps=koneksi.prepareStatement(
                    "select pemeriksaan_ranap.tgl_perawatan,pemeriksaan_ranap.jam_rawat,pemeriksaan_ranap.evaluasi "+
