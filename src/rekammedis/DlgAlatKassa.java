/*
dr. Salim Mulyana
di modif dari rs bedah halimun
*/
 ...
 * @author dosen
 */
public final class DlgAlatKassa extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgAlatKassa(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.setLocation(10,10);
        setSize(545,599);

        tabMode=new DefaultTableModel(null,new Object[]{"P","Kode Alat/Kassa","Nama Alat/ Kassa"}){
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Alat dan Kassa ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        jLabel3.setText("Kode Alat/Kassa :");
        jLabel3.setName("jLabel3"); // NOI18N
        panelGlass8.add(jLabel3);
        jLabel3.setBounds(5, 10, 100, 23);
        ...
        jLabel4.setText("Nama Alat/ Kassa:");
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TKd.getText().trim().equals("")){
            Valid.textKosong(TKd,"kode instrumen");
        }else if(TNm.getText().trim().equals("")){
            Valid.textKosong(TNm,"nama instrumen");
        }else{
            if(Sequel.menyimpantf("alatkassa_ok","?,?","Kode Alat/Kassa",2,new String[]{TKd.getText(),TNm.getText()})==true){
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        for(i=0;i<tbBangsal.getRowCount();i++){ 
            if(tbBangsal.getValueAt(i,0).toString().equals("true")){
                Sequel.meghapus("alatkassa_ok","kd_instrumen",tbBangsal.getValueAt(tbBangsal.getSelectedRow(),1).toString()); 
                //Sequel.meghapus("alatkassa_ok","kd_instrumen='"+tbBangsal.getValueAt(i,1).toString()+"'","status='0'");
                tabMode.removeRow(i);
                i--;
            }
        } 
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(TKd.getText().trim().equals("")){
            ...
            if(tbBangsal.getSelectedRow()>-1){
                if(Sequel.mengedittf("alatkassa_ok","kd_instrumen=?","nm_instrumen=?,kd_instrumen=?",3,new String[]{TNm.getText(),TKd.getText(),tbBangsal.getValueAt(tbBangsal.getSelectedRow(), 1).toString()})==true){
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgAlatKassa dialog = new DlgAlatKassa(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement("select * from alatkassa_ok where kd_instrumen like ? "+
                    "or nm_instrumen like ? order by kd_instrumen");
            try {
                ...
                System.out.println("Notif Instrumen : "+e);
            } finally{
                if(rs!=null){
                    rs.close();
                }
    ...
    public void emptTeks() {
        ...
        TCari.setText("");
        TKd.requestFocus();
        Valid.autoNomer(" alatkassa_ok ","AK",4,TKd);
    }
