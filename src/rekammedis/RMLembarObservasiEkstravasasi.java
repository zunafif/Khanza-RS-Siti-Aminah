 ...
 * @author perpustakaan
 */
public final class RMLembarObservasiEkstravasasi extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public RMLembarObservasiEkstravasasi(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            "No.Rawat","No.R.M.","Nama Pasien","Tgl.Lahir","JK","Tanggal","Warna Kulit","Nilai",
            "Suhu Kulit","Nilai","Perubahan Kulit","Nilai","Edema","Nilai","Pergerakan","Nilai",
            "Nyeri","Nilai","Demam","Nilai","Total","Nama Obat","Saran","NIP","Petugas"
        }){
    ...
    private void initComponents() {
        ...
        MnLembarObservasiEkstravasasi = new javax.swing.JMenuItem();
        ...
        MnLembarObservasiEkstravasasi.setBackground(new java.awt.Color(255, 255, 254));
        MnLembarObservasiEkstravasasi.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnLembarObservasiEkstravasasi.setForeground(new java.awt.Color(50, 50, 50));
        MnLembarObservasiEkstravasasi.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnLembarObservasiEkstravasasi.setText("Form Lembar Observasi Ekstravasasi");
        MnLembarObservasiEkstravasasi.setName("MnLembarObservasiEkstravasasi"); // NOI18N
        MnLembarObservasiEkstravasasi.setPreferredSize(new java.awt.Dimension(290, 26));
        MnLembarObservasiEkstravasasi.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnLembarObservasiEkstravasasiActionPerformed(evt);
            }
        });
        jPopupMenu1.add(MnLembarObservasiEkstravasasi);

        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        setUndecorated(true);
        setResizable(false);

        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Lembar Observasi Ekstravasasi ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        jLabel57.setText("Derajat Penilaian");
        jLabel57.setName("jLabel57"); // NOI18N
        FormInput.add(jLabel57);
        jLabel57.setBounds(640, 270, 90, 23);

        jLabel217.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel217.setText("1. Warna Kulit");
        jLabel217.setName("jLabel217"); // NOI18N
        FormInput.add(jLabel217);
        jLabel217.setBounds(34, 90, 200, 23);

        SkalaResiko1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Normal", "Merah Muda", "Merah", "Pucat dan sekeliling area merah", "Kehitaman" }));
        ...
        SkalaResiko1.setBounds(264, 90, 300, 23);
        ...
        NilaiResiko1.setBounds(739, 90, 50, 23);

        jLabel220.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel220.setText("2. Suhu Kulit");
        jLabel220.setName("jLabel220"); // NOI18N
        FormInput.add(jLabel220);
        jLabel220.setBounds(34, 120, 200, 23);

        SkalaResiko2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Normal", "Hangat", "Panas" }));
        ...
        SkalaResiko2.setBounds(264, 120, 300, 23);
        ...
        NilaiResiko2.setBounds(739, 120, 50, 23);

        jLabel223.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel223.setText("3. Perubahan Kulit");
        jLabel223.setName("jLabel223"); // NOI18N
        FormInput.add(jLabel223);
        jLabel223.setBounds(34, 150, 200, 23);

        SkalaResiko3.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak terputus-putus", "Agak Bengkak", "Luaran kulit mengelupas", "Menembus jaringan subkutan", "Menembus jaringan hingga tulang dengan nekrosis" }));
        ...
        SkalaResiko3.setBounds(264, 150, 300, 23);
        ...
        NilaiResiko3.setBounds(739, 150, 50, 23);

        jLabel226.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel226.setText("4. Edema");
        jLabel226.setName("jLabel226"); // NOI18N
        FormInput.add(jLabel226);
        jLabel226.setBounds(34, 180, 200, 23);

        SkalaResiko4.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak Ada", "Agak Bengkak" }));
        ...
        SkalaResiko4.setBounds(264, 180, 300, 23);
        ...
        NilaiResiko4.setBounds(739, 180, 50, 23);

        jLabel229.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel229.setText("5. Pergerakan");
        jLabel229.setName("jLabel229"); // NOI18N
        FormInput.add(jLabel229);
        jLabel229.setBounds(34, 210, 200, 23);

        SkalaResiko5.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Lentur", "Agak Bengkak", "Sangat Terbatas", "Tidak dapat digerakkan(keras)" }));
        ...
        SkalaResiko5.setBounds(264, 210, 300, 23);
        ...
        NilaiResiko5.setBounds(739, 210, 50, 23);

        jLabel232.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel232.setText("6. Nyeri");
        jLabel232.setName("jLabel232"); // NOI18N
        FormInput.add(jLabel232);
        jLabel232.setBounds(34, 240, 210, 23);

        SkalaResiko6.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "1/10", "2/10", "3/10", "4/10", "5/10", "6/10", "7/10", "8/10", "9/10", "10/10" }));
        ...
        SkalaResiko6.setBounds(264, 240, 300, 23);
        ...
        NilaiResiko6.setBounds(739, 240, 50, 23);

        jLabel235.setText("Total :");
        jLabel235.setName("jLabel235"); // NOI18N
        FormInput.add(jLabel235);
        jLabel235.setBounds(300, 600, 70, 23);
        ...
        NilaiResikoTotal.setBounds(370, 600, 40, 23);
        ...
        jLabel31.setBounds(20, 530, 80, 23);
        ...
        scrollPane2.setBounds(40, 550, 755, 43);
        ...
        jLabel233.setText("7. Demam");
        jLabel233.setName("jLabel233"); // NOI18N
        FormInput.add(jLabel233);
        jLabel233.setBounds(34, 270, 210, 23);

        SkalaResiko7.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Normal", "Meningkat" }));
        ...
        SkalaResiko7.setBounds(264, 270, 300, 23);
        ...
        NilaiResiko7.setBounds(739, 270, 50, 23);

        jLabel58.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel58.setText("Kriteria Penilaian : ");
        jLabel58.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel58.setName("jLabel58"); // NOI18N
        FormInput.add(jLabel58);
        jLabel58.setBounds(30, 70, 120, 23);

        jLabel59.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel59.setText("Derajat Penilaian");
        jLabel59.setName("jLabel59"); // NOI18N
        FormInput.add(jLabel59);
        jLabel59.setBounds(640, 120, 90, 23);

        jLabel60.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel60.setText("Derajat Penilaian");
        jLabel60.setName("jLabel60"); // NOI18N
        FormInput.add(jLabel60);
        jLabel60.setBounds(640, 150, 90, 23);

        jLabel61.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel61.setText("Derajat Penilaian");
        jLabel61.setName("jLabel61"); // NOI18N
        FormInput.add(jLabel61);
        jLabel61.setBounds(640, 180, 90, 23);

        jLabel62.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel62.setText("Derajat Penilaian");
        jLabel62.setName("jLabel62"); // NOI18N
        FormInput.add(jLabel62);
        jLabel62.setBounds(640, 210, 90, 23);

        jLabel63.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel63.setText("Derajat Penilaian");
        jLabel63.setName("jLabel63"); // NOI18N
        FormInput.add(jLabel63);
        jLabel63.setBounds(640, 240, 90, 23);

        jLabel64.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel64.setText("Derajat Penilaian");
        jLabel64.setName("jLabel64"); // NOI18N
        FormInput.add(jLabel64);
        jLabel64.setBounds(640, 90, 90, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRw.getText().trim().equals("")||TPasien.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("lembar_observasi_ekstravasasi","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","Data",20,new String[]{
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            if(TCari.getText().trim().equals("")){
                Valid.MyReportqry("rptLembarObservasiEkstravasasi.jasper","report","::[ Lembar Observasi Ekstravasasi ]::",
                    "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,pasien.jk,pasien.tgl_lahir,lembar_observasi_ekstravasasi.tanggal,"+
                    "lembar_observasi_ekstravasasi.penilaian_humptydumpty_skala1,lembar_observasi_ekstravasasi.penilaian_humptydumpty_nilai1,"+
                    "lembar_observasi_ekstravasasi.penilaian_humptydumpty_skala2,lembar_observasi_ekstravasasi.penilaian_humptydumpty_nilai2,"+
                    "lembar_observasi_ekstravasasi.penilaian_humptydumpty_skala3,lembar_observasi_ekstravasasi.penilaian_humptydumpty_nilai3,"+
                    "lembar_observasi_ekstravasasi.penilaian_humptydumpty_skala4,lembar_observasi_ekstravasasi.penilaian_humptydumpty_nilai4,"+
                    "lembar_observasi_ekstravasasi.penilaian_humptydumpty_skala5,lembar_observasi_ekstravasasi.penilaian_humptydumpty_nilai5,"+
                    "lembar_observasi_ekstravasasi.penilaian_humptydumpty_skala6,lembar_observasi_ekstravasasi.penilaian_humptydumpty_nilai6,"+
                    "lembar_observasi_ekstravasasi.penilaian_humptydumpty_skala7,lembar_observasi_ekstravasasi.penilaian_humptydumpty_nilai7,"+
                    "lembar_observasi_ekstravasasi.penilaian_humptydumpty_totalnilai,lembar_observasi_ekstravasasi.hasil_skrining,"+
                    "lembar_observasi_ekstravasasi.saran,lembar_observasi_ekstravasasi.nip,petugas.nama "+
                    "from lembar_observasi_ekstravasasi inner join reg_periksa on lembar_observasi_ekstravasasi.no_rawat=reg_periksa.no_rawat "+
                    "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "inner join petugas on lembar_observasi_ekstravasasi.nip=petugas.nip where "+
                    "lembar_observasi_ekstravasasi.tanggal between '"+Valid.SetTgl(DTPCari1.getSelectedItem()+"")+" 00:00:00' and '"+Valid.SetTgl(DTPCari2.getSelectedItem()+"")+" 23:59:59' "+
                    "order by lembar_observasi_ekstravasasi.tanggal",param);
            }else{
                Valid.MyReportqry("rptLembarObservasiEkstravasasi.jasper","report","::[ Lembar Observasi Ekstravasasi ]::",
                    "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,pasien.jk,pasien.tgl_lahir,lembar_observasi_ekstravasasi.tanggal,"+
                    "lembar_observasi_ekstravasasi.penilaian_humptydumpty_skala1,lembar_observasi_ekstravasasi.penilaian_humptydumpty_nilai1,"+
                    ...
                    "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "inner join petugas on lembar_observasi_ekstravasasi.nip=petugas.nip where "+
                    "lembar_observasi_ekstravasasi.tanggal between '"+Valid.SetTgl(DTPCari1.getSelectedItem()+"")+" 00:00:00' and '"+Valid.SetTgl(DTPCari2.getSelectedItem()+"")+" 23:59:59' and "+
                    ...
                    "or lembar_observasi_ekstravasasi.nip like '%"+TCari.getText().trim()+"%' or petugas.nama like '%"+TCari.getText().trim()+"%') "+
                    "order by lembar_observasi_ekstravasasi.tanggal ",param);
            }  
        }
    ...
    private void MnLembarObservasiEkstravasasiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnLembarObservasiEkstravasasiActionPerformed
        if(tbObat.getSelectedRow()>-1){
            Map<String, Object> param = new HashMap<>();
            param.put("namars",akses.getnamars());
            param.put("alamatrs",akses.getalamatrs());
            ...
            Valid.MyReportqry("rptLembarObservasiEkstravasasi.jasper","report","::[ Formulir Penilaian Lanjutan Risiko Jatuh Anak ]::",
                    "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,pasien.jk,pasien.tgl_lahir,lembar_observasi_ekstravasasi.tanggal,"+
                    "lembar_observasi_ekstravasasi.penilaian_humptydumpty_skala1,lembar_observasi_ekstravasasi.penilaian_humptydumpty_nilai1,"+
                    "lembar_observasi_ekstravasasi.penilaian_humptydumpty_skala2,lembar_observasi_ekstravasasi.penilaian_humptydumpty_nilai2,"+
                    "lembar_observasi_ekstravasasi.penilaian_humptydumpty_skala3,lembar_observasi_ekstravasasi.penilaian_humptydumpty_nilai3,"+
                    ...
                    "from lembar_observasi_ekstravasasi inner join reg_periksa on lembar_observasi_ekstravasasi.no_rawat=reg_periksa.no_rawat "+
                    "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "inner join petugas on lembar_observasi_ekstravasasi.nip=petugas.nip where reg_periksa.no_rawat='"+tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()+"'",param);
        }
    }//GEN-LAST:event_MnLembarObservasiEkstravasasiActionPerformed
    ...
    private void SkalaResiko6ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_SkalaResiko6ItemStateChanged
        ...
        }else if(SkalaResiko6.getSelectedIndex()==7){
            NilaiResiko6.setText("7");
        }else if(SkalaResiko6.getSelectedIndex()==8){
            NilaiResiko6.setText("8");
        }else if(SkalaResiko6.getSelectedIndex()==9){
            NilaiResiko6.setText("9");
        }else if(SkalaResiko6.getSelectedIndex()==10){
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMLembarObservasiEkstravasasi dialog = new RMLembarObservasiEkstravasasi(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JMenuItem MnLembarObservasiEkstravasasi;
        ...
        try{
            if(TCari.getText().toString().trim().equals("")){
                ps=koneksi.prepareStatement(
                    ...
                    "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "inner join petugas on lembar_observasi_ekstravasasi.nip=petugas.nip where "+
                    "lembar_observasi_ekstravasasi.tanggal between ? and ? order by lembar_observasi_ekstravasasi.tanggal");
            }else{
                ps=koneksi.prepareStatement(
                    "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,pasien.jk,pasien.tgl_lahir,lembar_observasi_ekstravasasi.tanggal,"+
                    "lembar_observasi_ekstravasasi.penilaian_humptydumpty_skala1,lembar_observasi_ekstravasasi.penilaian_humptydumpty_nilai1,"+
                    ...
                    "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "inner join petugas on lembar_observasi_ekstravasasi.nip=petugas.nip where "+
                    "lembar_observasi_ekstravasasi.tanggal between ? and ? and (reg_periksa.no_rawat like ? or pasien.no_rkm_medis like ? or pasien.nm_pasien like ? or lembar_observasi_ekstravasasi.nip like ? or petugas.nama like ?) "+
                    "order by lembar_observasi_ekstravasasi.tanggal ");
            }
    ...
    private void ganti() {
        Sequel.mengedit("lembar_observasi_ekstravasasi","tanggal=? and no_rawat=?","no_rawat=?,tanggal=?,penilaian_humptydumpty_skala1=?,penilaian_humptydumpty_nilai1=?,"+
    ...
    private void hapus() {
        if(Sequel.queryu2tf("delete from lembar_observasi_ekstravasasi where tanggal=? and no_rawat=?",2,new String[]{
