 ...
 * @author perpustakaan
 */
public final class RMPenilaianAwalRisikoJatuhNeonatus extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public RMPenilaianAwalRisikoJatuhNeonatus(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            ...
            "Tindakan 9","Edukasi 1","Edukasi 2","Edukasi 3","Edukasi 4","Edukasi 5","Sasaran Edukasi",
            "Evaluasi 1","Evaluasi 2","Evaluasi 3","NIP","Petugas"
        }){
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Penilaian Awal Risiko Jatuh Pasien Neonatus ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        FormInput.setPreferredSize(new java.awt.Dimension(1200, 600));
        ...
        jLabel57.setText("Tindakan Pencegahan :");
        jLabel57.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel57.setName("jLabel57"); // NOI18N
        FormInput.add(jLabel57);
        jLabel57.setBounds(14, 70, 290, 23);

        jLabel217.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel217.setText("1. Pasang gelang resiko jatuh");
        jLabel217.setName("jLabel217"); // NOI18N
        FormInput.add(jLabel217);
        jLabel217.setBounds(30, 90, 190, 23);
        ...
        SkalaResiko1.setBounds(320, 90, 100, 23);

        jLabel220.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel220.setText("2. Pasang sign resiko jatuh ditempat tidur/Inkubator Bayi");
        jLabel220.setName("jLabel220"); // NOI18N
        FormInput.add(jLabel220);
        jLabel220.setBounds(30, 120, 310, 23);
        ...
        SkalaResiko2.setBounds(320, 120, 100, 23);

        jLabel223.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel223.setText("3. Dekatkan tempat tidur bayi dengan ibu");
        jLabel223.setName("jLabel223"); // NOI18N
        FormInput.add(jLabel223);
        jLabel223.setBounds(30, 150, 310, 23);
        ...
        SkalaResiko3.setBounds(320, 150, 100, 23);

        jLabel226.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel226.setText("4. Pastikan lantai dan alas kaki tidak licin");
        jLabel226.setName("jLabel226"); // NOI18N
        FormInput.add(jLabel226);
        jLabel226.setBounds(30, 180, 310, 23);
        ...
        SkalaResiko4.setBounds(320, 180, 100, 23);
        ...
        SkalaResiko5.setBounds(320, 210, 100, 23);

        jLabel232.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel232.setText("9. Edukasi kepada orang tua /keluarga");
        jLabel232.setName("jLabel232"); // NOI18N
        jLabel232.setPreferredSize(new java.awt.Dimension(129, 14));
        FormInput.add(jLabel232);
        jLabel232.setBounds(430, 200, 270, 20);
        ...
        SkalaResiko6.setBounds(720, 90, 100, 23);
        ...
        SkalaResiko12.setBounds(320, 350, 100, 23);

        jLabel244.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel244.setText("4. Segera istirahat apabila merasa lelah dan tempatkan");
        jLabel244.setName("jLabel244"); // NOI18N
        jLabel244.setPreferredSize(new java.awt.Dimension(129, 14));
        FormInput.add(jLabel244);
        jLabel244.setBounds(30, 380, 350, 20);
        ...
        SkalaResiko13.setBounds(320, 380, 100, 23);

        jLabel245.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel245.setText("5. Libatkan keluarga untuk mendampingi atau segera ");
        jLabel245.setName("jLabel245"); // NOI18N
        jLabel245.setPreferredSize(new java.awt.Dimension(129, 14));
        FormInput.add(jLabel245);
        jLabel245.setBounds(30, 420, 310, 20);
        ...
        SkalaResiko18.setBounds(720, 440, 100, 23);

        jLabel246.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel246.setText("3. Perlu edukasi ulang");
        jLabel246.setName("jLabel246"); // NOI18N
        jLabel246.setPreferredSize(new java.awt.Dimension(129, 14));
        FormInput.add(jLabel246);
        jLabel246.setBounds(430, 440, 310, 20);

        jLabel247.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel247.setText("1. Memahami dan mampu menjelaskan kembali");
        jLabel247.setName("jLabel247"); // NOI18N
        jLabel247.setPreferredSize(new java.awt.Dimension(129, 14));
        FormInput.add(jLabel247);
        jLabel247.setBounds(430, 380, 310, 20);

        jLabel252.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel252.setText("2. Mampu mendemonstrasikan");
        jLabel252.setName("jLabel252"); // NOI18N
        jLabel252.setPreferredSize(new java.awt.Dimension(129, 14));
        FormInput.add(jLabel252);
        jLabel252.setBounds(430, 410, 310, 20);
        ...
        SkalaResiko16.setBounds(720, 380, 100, 23);
        ...
        SkalaResiko17.setBounds(720, 410, 100, 23);

        jLabel254.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel254.setText("1. Sasaran edukasi");
        jLabel254.setName("jLabel254"); // NOI18N
        jLabel254.setPreferredSize(new java.awt.Dimension(129, 14));
        FormInput.add(jLabel254);
        jLabel254.setBounds(430, 290, 310, 20);

        SkalaResiko15.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Ibu", "Ayah", "Wali", "Lainnya" }));
        ...
        SkalaResiko15.setBounds(720, 290, 100, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRw.getText().trim().equals("")||TPasien.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("penilaian_awal_resiko_jatuh_neonatus","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","Data",21,new String[]{
                ...
                SkalaResiko15.getSelectedItem().toString(),SkalaResiko16.getSelectedItem().toString(),
                SkalaResiko17.getSelectedItem().toString(),SkalaResiko18.getSelectedItem().toString(),
                NIP.getText()
            })==true){
                tampil();
                emptTeks();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMPenilaianAwalRisikoJatuhNeonatus dialog = new RMPenilaianAwalRisikoJatuhNeonatus(new javax.swing.JFrame(), true);
        ...
        try{
            if(TCari.getText().toString().trim().equals("")){
                ps=koneksi.prepareStatement(
                    "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,pasien.jk,pasien.tgl_lahir,penilaian_awal_resiko_jatuh_neonatus.tanggal,"+
                    "penilaian_awal_resiko_jatuh_neonatus.penilaian_jatuhmorse_skala1,"+
                    "penilaian_awal_resiko_jatuh_neonatus.penilaian_jatuhmorse_skala2,"+
                    "penilaian_awal_resiko_jatuh_neonatus.penilaian_jatuhmorse_skala3,"+
                    "penilaian_awal_resiko_jatuh_neonatus.penilaian_jatuhmorse_skala4,"+
                    "penilaian_awal_resiko_jatuh_neonatus.penilaian_jatuhmorse_skala5,"+
                    "penilaian_awal_resiko_jatuh_neonatus.penilaian_jatuhmorse_skala6,"+
                    "penilaian_awal_resiko_jatuh_neonatus.penilaian_jatuhmorse_skala7,"+
                    "penilaian_awal_resiko_jatuh_neonatus.penilaian_jatuhmorse_skala8,"+
                    "penilaian_awal_resiko_jatuh_neonatus.penilaian_jatuhmorse_skala9,"+
                    "penilaian_awal_resiko_jatuh_neonatus.penilaian_jatuhmorse_skala10,"+
                    "penilaian_awal_resiko_jatuh_neonatus.penilaian_jatuhmorse_skala11,"+
                    "penilaian_awal_resiko_jatuh_neonatus.penilaian_jatuhmorse_skala12,"+
                    "penilaian_awal_resiko_jatuh_neonatus.penilaian_jatuhmorse_skala13,"+
                    "penilaian_awal_resiko_jatuh_neonatus.penilaian_jatuhmorse_skala14,"+
                    "penilaian_awal_resiko_jatuh_neonatus.penilaian_jatuhmorse_skala15,"+
                    "penilaian_awal_resiko_jatuh_neonatus.penilaian_jatuhmorse_skala16,"+
                    "penilaian_awal_resiko_jatuh_neonatus.penilaian_jatuhmorse_skala17,"+
                    "penilaian_awal_resiko_jatuh_neonatus.penilaian_jatuhmorse_skala18,"+
                    "penilaian_awal_resiko_jatuh_neonatus.nip,petugas.nama "+
                    "from penilaian_awal_resiko_jatuh_neonatus inner join reg_periksa on penilaian_awal_resiko_jatuh_neonatus.no_rawat=reg_periksa.no_rawat "+
                    "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "inner join petugas on penilaian_awal_resiko_jatuh_neonatus.nip=petugas.nip where "+
                    "penilaian_awal_resiko_jatuh_neonatus.tanggal between ? and ? order by penilaian_awal_resiko_jatuh_neonatus.tanggal");
            }else{
                ps=koneksi.prepareStatement(
                    "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,pasien.jk,pasien.tgl_lahir,penilaian_awal_resiko_jatuh_neonatus.tanggal,"+
                    "penilaian_awal_resiko_jatuh_neonatus.penilaian_jatuhmorse_skala1,"+
                    ...
                    "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "inner join petugas on penilaian_awal_resiko_jatuh_neonatus.nip=petugas.nip where "+
                    "penilaian_awal_resiko_jatuh_neonatus.tanggal between ? and ? and (reg_periksa.no_rawat like ? or pasien.no_rkm_medis like ? or pasien.nm_pasien like ? or penilaian_awal_resiko_jatuh_neonatus.nip like ? or petugas.nama like ?) "+
                    "order by penilaian_awal_resiko_jatuh_neonatus.tanggal ");
            }
            ...
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new String[]{
                        ...
                        rs.getString("penilaian_jatuhmorse_skala15"),rs.getString("penilaian_jatuhmorse_skala16"),
                        rs.getString("penilaian_jatuhmorse_skala17"),rs.getString("penilaian_jatuhmorse_skala18"),
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            SkalaResiko15.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),20).toString());
            SkalaResiko16.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),21).toString());
            SkalaResiko17.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),22).toString());
            SkalaResiko18.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),23).toString());
    ...
    private void ganti() {
        Sequel.mengedit("penilaian_awal_resiko_jatuh_neonatus","tanggal=? and no_rawat=?","no_rawat=?,tanggal=?,"+
            ...
            "penilaian_jatuhmorse_skala10=?,penilaian_jatuhmorse_skala11=?,penilaian_jatuhmorse_skala12=?,"+
            "penilaian_jatuhmorse_skala13=?,penilaian_jatuhmorse_skala14=?,penilaian_jatuhmorse_skala15=?,"+
            "penilaian_jatuhmorse_skala16=?,penilaian_jatuhmorse_skala17=?,penilaian_jatuhmorse_skala18=?,"+
            "nip=?",23,new String[]{
            TNoRw.getText(),Valid.SetTgl(Tanggal.getSelectedItem()+"")+" "+Jam.getSelectedItem()+":"+Menit.getSelectedItem()+":"+Detik.getSelectedItem(),
            SkalaResiko1.getSelectedItem().toString(),SkalaResiko2.getSelectedItem().toString(),
            SkalaResiko3.getSelectedItem().toString(),SkalaResiko4.getSelectedItem().toString(), 
    ...
    private void hapus() {
        if(Sequel.queryu2tf("delete from penilaian_awal_resiko_jatuh_neonatus where tanggal=? and no_rawat=?",2,new String[]{
