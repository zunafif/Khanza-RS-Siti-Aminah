...
<html lang="en">
  ...
  <body>
    <div class="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
      ...
      <h7><span style="color:white" id="waktu">25200</span></h7>
      ...
      <div class="modal-dialog modal-dialog-centered modal-lg  modal-fix" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h2 class="modal-title" id="exampleModalCenterTitle">Antrian Loket RSUD Prof.Dr.H.M.ANWAR MAKKATUTU BANTAENG</h2>
          ...
          <div class="modal-body">
            ...
            <div class="col-4 pt-1 pb-1">
              ...
              <form role="form" id="formloket" name="formloket">
                <button type="submit" class="btn btn-lg btn-success btn-block" id="btnKRM" value="Submit" name="btnKRM" onclick="printDiv('printAntrianLoket');"><font color="black">PASIEN LAMA</font></button>
              </form>
            </div>
            <div class="col-4 pt-1 pb-1">
              ...
              <form role="form" id="formcs" name="formcs">
                <button type="submit" class="btn btn-lg btn-primary btn-block" id="btnKRMCS" value="Submit" name="btnKRMCS" onclick="printDiv('printAntrianCS');"><font color="black">PASIEN BARU</font></button>
              </form>
            </div>
            <div class="col-4 pt-1 pb-1">
              ...
              <form role="form" id="formpr" name="formpr">
                <button type="submit" class="btn btn-lg btn-warning btn-block" id="btnKRMpr" value="Submit" name="btnKRMpr" onclick="printDiv('printAntrianpr');"><font color="black">PASIEN PRORITAS</font></button>
              </form>
            </div>
			</div>
          </div>
      ...
      <div class="modal-dialog modal-dialog-centered modal-lg modal-fix" role="document">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <button type="button" class="close" data-dismiss="modal" onclick="javascript:window.location='/anjungan/'" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-secondary" data-dismiss="modal" onclick="javascript:window.location='/anjungan/'">Tutup</button>
          </div>
        </div>
      </div>
    </div>
