...
<div align="center" class="kontainer" style="color:white; text-shadow: 2px 2px 4px #000000;">Sistem Antrian Loket</div>
 <center><span class="blink"><font color="brown" face="Maiandra GD" ><font size="4"> RSUD Prof DR H M Anwar Makkatutu Bantaeng <br> </font></font></span></center>
		...
		<audio id="pasienlama" src="rekaman/Pasienbaru.wav"></audio>
		<audio id="suarabelnomorurut" src="rekaman/no_urut.wav"  ></audio>  
		<audio id="b" src="rekaman/b.wav"  ></audio>  
		...
		<?php
			...
			$antrian=$tcounter;
   						$query5 = "DELETE FROM antrian_monitor_baru";
						 $hasil4 = mysqli_query($connection,$query5);
						 $query3="INSERT INTO antrian_monitor_baru(baru) VALUE ($antrian)";	
		...
		<tbody>
                          <tr>
                            <td style="background-color:#FFCC66" colspan='4' align='center'  scope="row"><b>LOKET 4</b></td>
						</tr>
						  <tr>
							 <td style="background-color:#FFCC66" colspan='4' align='center'  scope="row">Pasien Baru</td>
                          </tr>
                          <tr>
                            <td style="background-color:#FFCC66" colspan='3' align='center' >
							<div class="kontainer">
							<div><a id="konter"> <?php echo 'B'.$antrian; ?></a>
							</div>
							</div>
							</td>
          					  <td style="background-color:#FFCC66" ><div align="center"><input name="play" onclick="mulai();" id="tombol" type="image" src="icon.png" value="Panggil" /></div>
							  <br> <br>
								 <a  href="hapus45.php" />
                          ...
                          <tr>
						  <td style="background-color:#FFCC66" ><div><id="konter" id='screen'>  
						  </a></div></td>
                            <td style="background-color:#FFCC66"><div ><a id="konter" href="hapus44.php">back</a></div></td>
						  <td style="background-color:#FFCC66"><div align="center">
                            <?php
                              echo "
								<form action='pasienb4.php' method= 'post' >
                           ...
                           <td style="background-color:#FFCC66"><div ><a id="konter" href="pasien_baru_loket4.php">Next</a></div></td>
                          </tr>
                        </tbody></table>
						<br>
						...
						<tbody>
                          <tr>
						  <td style="background-color:#FFCC66"><div ><a id="konter" href="index.php">Kembali</a></div></td>
