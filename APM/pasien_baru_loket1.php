...
<div align="center" class="kontainer" style="color:white; text-shadow: 2px 2px 4px #000000;">Sistem Antrian Loket</div>
 <center><span class="blink"><font color="brown" face="Maiandra GD" ><font size="4"> RSUD Prof DR H M Anwar Makkatutu Bantaeng <br> </font></font></span></center>
		...
		<tbody>
                          <tr>
                            <td style="background-color:#99FF99" colspan='4' align='center'  scope="row"><b>LOKET 1</b></td>
						</tr>
						  <tr>
							 <td style="background-color:#99FF99" colspan='4' align='center'  scope="row">Pasien Baru</td>
                          </tr>
                          <tr>
                            <td style="background-color:#99FF99" colspan='3' align='center' >
							<div class="kontainer">
							<div><a id="konter"> <?php echo 'B'.$antrian; ?></a>
							</div>
							</div>
							</td>
          					  <td style="background-color:#99FF99"><div align="center"><input name="play" onclick="mulai();" id="tombol" type="image" src="icon.png" value="Panggil" /></div>
							  <br> <br>
								 <a  href="hapus48.php"/>
                          ...
                          <tr>
						  <td style="background-color:#99FF99"><div><id="konter" id='screen'>  
						  </a></div></td>
                            <td style="background-color:#99FF99"><div ><a id="konter" href="hapus4.php">back</a></div></td>
						  <td style="background-color:#99FF99"><div align="center">
                            <?php
                              echo "
								<form action='pasienb.php' method= 'post' >
                           ...
                           <td style="background-color:#99FF99"><div ><a id="konter" href="pasien_baru_loket1.php">Next</a></div></td>
                          </tr>
                        </tbody></table>
						<br>
						...
						<tbody>
                          <tr>
						  <td style="background-color:#99FF99"><div ><a id="konter" href="index.php">Kembali</a></div></td>
