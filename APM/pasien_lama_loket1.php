   ...
   <center><span class="blink"><font color="brown" face="Maiandra GD" ><font size="4"> RSUD Prof DR H M Anwar Makkatutu Bantaeng <br> </font></font></span></center>
		...
		<div id="wrapper">
         ...
         <div class="modal-body">
          <table align="center" border="10px "  cellpadding="15" bgcolor="transparent">
		<tbody>
				<tr>
                    <td style="background-color:#99FF99" colspan='4' align='center'  scope="row"><b>LOKET 1</b></td>
				</tr>
				<tr>
						<td style="background-color:#99FF99" colspan='4' align='center'  scope="row">Pasien Lama</td>
                </tr>
						<tr>
                        <td style="background-color:#99FF99" colspan='3' align='center' >
						<div class="kontainer">
						<div><a id="konter"><?php echo 'L'.$antrian; ?></a></div>
						</div>
						</td>
				...
				<br> <br>
                    ...
                    <tr>
                       ...
                       <td style="background-color:#99FF99" ><div ><a id="konter" href="hapus3.php">back</a></div></td>
						<td style="background-color:#99FF99"><div align="center" >
                          <?php
                              echo "
								<form action='pasienl.php' method= 'post' >
									<input type='number' min='1' name='data' style='width: 3em'></input>
								<input type='image' src='enter.png'></input>
								</form>";
                             ?>
                          </div></td>
						<td style="background-color:#99FF99"><div ><a id="konter" href="pasien_lama_loket1.php">Next</a></div></td>
					</tr>
        </tbody></table>
