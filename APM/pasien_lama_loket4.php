         ...
         <div class="modal-body">
			...
			<tbody>
						  ...
						  <tr>
							 ...
							 <td style="background-color:#FFCC66" colspan='4' align='center'  scope="row">Pasien Lama</td>
                          </tr>
                          <tr>
                            ...
                            <td style="background-color:#FFCC66" ><div align="center" ><input name="play" onclick="mulai4();" id="tombol" type="image" src="icon.png" value="Panggil"  /></div>
							<br> <br>
								 <a  href="hapus35.php"/>
                          ...
                          <tr>
						    <td style="background-color:#FFCC66" ><div><id="konter" id='screen5'>  
						  </a></div></td>
                             <td style="background-color:#FFCC66" ><div ><a id="konter" href="hapus34.php">back</a></div></td>
						   <td style="background-color:#FFCC66" ><div align="center" >
                            <?php
                              echo "
								<form action='pasienl4.php' method= 'post' >
									<input type='number' min='1' name='data' style='width: 3em'></input>
								<input type='image' src='enter.png'></input>
								</form>";
                             ?>
                             </div></td>
						   <td style="background-color:#FFCC66"><div ><a id="konter" href="pasien_lama_loket4.php">Next</a></div></td> </tr>
