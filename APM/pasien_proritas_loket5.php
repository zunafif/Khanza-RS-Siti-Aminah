...
include ('config.php');
//$lama = 1;
//$query = "DELETE FROM antrian_pr
         // WHERE DATEDIFF(CURDATE(), postdate) > $lama";
//$query2 = "DELETE FROM antrian_pr WHERE kd IN (SELECT * FROM (SELECT kd FROM antrian_pr GROUP BY noantrian HAVING (COUNT(*) > 1)) AS A)";
...
<div align="center" class="kontainer" style="color:white; text-shadow: 2px 2px 4px #000000;">Sistem Antrian Loket</div>
 <center><span class="blink"><font color="brown" face="Maiandra GD" ><font size="4"> RSUD Prof DR H M Anwar Makkatutu Bantaeng <br> </font></font></span></center>
		...
		<audio id="suarabelloket5" src="rekaman/<?php echo $loket5; ?>.wav"  ></audio> 
		...
		<?php
			...
			$antrian=$tcounter;
  						 ...
  						 $query5 = "DELETE FROM antrian_monitor_prioritas";
						 $hasil4 = mysqli_query($connection,$query5);
						 $query3="INSERT INTO antrian_monitor_prioritas(prioritas) VALUE ($antrian)";	
		...
		<tbody>
                          <tr>
                            <td style="background-color:#FF9966" colspan='4' align='center'  scope="row"><b>LOKET 5</b></td>
						</tr>
						  <tr>
							 <td style="background-color:#FF9966" colspan='4' align='center'  scope="row">Pasien Proritas</td>
                          </tr>
                          <tr>
						  
                            <td style="background-color:#FF9966" colspan='3' align='center' >
							<div class="kontainer">
							<div><a id="konter" ><?php echo 'P'.$antrian;?>
							
							</a>
							</div>
							</div>
							</td>
          						<td style="background-color:#FF9966" ><div align="center"><input name="play" onclick="mulai();" onClick="document.location.reload(true)" id="tombol" type="image" src="icon.png" value="Panggil"/>
								<br> <br>
								 <a  href="hapus51.php" />
						 ...
						 <td style="background-color:#FF9966">
						   <div ><id="konter" id='screen'>  
							
						  </a></div>
						 </td>
                            <td style="background-color:#FF9966"><div ><a id="konter" href="hapus5.php">back</a></div></td>
						   <td style="background-color:#FF9966"><div align="center"><?php
                              echo "
								<form action='pasienp.php' method= 'post' >
                            ...
                            <td style="background-color:#FF9966">
							<div >
							<a id="konter" href="pasien_proritas_loket5.php">Next</a></div></td> </tr>
							 </tr>
                        </tbody></table>
						
						<table align="center" border="0" cellpadding="15" bgcolor="transparent">
						<tbody>
						<br>
                          <tr>
						  <td colspan='4' align='left'  style="background-color:#FF9966"><div ><a id="konter" href="index.php">Kembali</a></div></td>
                            <td colspan='4' align='left'  scope="row"><b></b></td>
						</tr>
