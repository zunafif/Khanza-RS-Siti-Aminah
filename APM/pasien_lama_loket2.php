         ...
         <div class="modal-body">
			...
			<tbody>
						  ...
						  <tr>
							 ...
							 <td style="background-color:#66CCFF" colspan='4' align='center'  scope="row">Pasien Lama</td>
                          </tr>
                          <tr>
              			...
              			<td style="background-color:#66CCFF" ><div align="center" ><input name="play" onclick="mulai2();" id="tombol" type="image" src="icon.png" value="Panggil"  /></div>
						<br> <br>
								 <a  href="hapus37.php" />
                           ...
                           <tr>
						    <td style="background-color:#66CCFF"><div><id="konter" id='screen2'>  
						  </a></div></td>
                              <td style="background-color:#66CCFF"><div ><a id="konter" href="hapus32.php">back</a></div></td>
						   <td style="background-color:#66CCFF"><div align="center" >
                             <?php
                              echo "
								<form action='pasienl2.php' method= 'post' >
									<input type='number' min='1' name='data' style='width: 3em'></input>
								<input type='image' src='enter.png'></input>
								</form>";
                             ?>
                             </div></td>
						   <td style="background-color:#66CCFF"><div ><a id="konter" href="pasien_lama_loket2.php">Next</a></div></td>
                          </tr>
