        ...
        if(connection == null){
            try{
                ...
                System.out.println("  Koneksi Berhasil. Sorry bro loading, silahkan baca dulu.... \n\n"+
                        "	Software ini adalah Software yang Source Code Orinya Berasal Dari Yaski\n" +
                        "  Siapa Saja Boleh Mengembangkan Dengan Seijin Pihak Yaski\n" +
                        "  Dilarang keras memperjualbelikan\n\n" +
